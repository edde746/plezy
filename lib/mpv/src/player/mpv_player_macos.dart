...
import '../models/mpv_log_level.dart';
...
/// macOS implementation of [MpvPlayer] using MPVKit via platform channels.
class MpvPlayerMacOS implements MpvPlayer {
  ...
  @override
  int? get textureId => null; // macOS uses direct Metal layer, not Flutter texture
