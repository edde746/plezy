...
///
/// Locales: 6
/// Strings: 3088 (514 per locale)
///
/// Built on 2025-12-12 at 15:54 UTC
...
class _StringsSettingsEn {
	...
	String get downloadLocationNotSupported => 'Custom download location is not supported on iOS';
...
class _StringsMessagesEn {
	...
	String get offlineFeatureUnavailable => 'This feature requires an internet connection. Your downloads and settings are still available.';
}
...
class _StringsDiscoverEn {
	...
	String resumeEpisode({required Object season, required Object episode}) => 'S${season}E${episode}';
...
class _StringsDownloadsEn {
	...
	String get browseContent => 'Browse content';
	...
	String get deleteConfirmMessage => 'This will remove the downloaded file from your device.';
	...
	String deletingSimple({required Object title}) => 'Deleting ${title}...';
...
class _StringsOfflineEn {
	...
	String get showingDownloadedContent => 'Showing downloaded content only';
	String get noInternetConnection => 'No internet connection';
	String get serversUnreachable => 'Plex servers unreachable';
	String get connectToDownload => 'Connect to the internet to download content';
}
...
class _StringsSettingsDe implements _StringsSettingsEn {
	...
	@override String get downloadLocationNotSupported => 'Benutzerdefinierter Download-Speicherort wird auf iOS nicht unterstützt';
...
class _StringsMessagesDe implements _StringsMessagesEn {
	...
	@override String get youAreOffline => 'Du bist offline';
	@override String get offlineFeatureUnavailable => 'Diese Funktion erfordert eine Internetverbindung. Deine Downloads und Einstellungen sind weiterhin verfügbar.';
}
...
class _StringsDownloadsDe implements _StringsDownloadsEn {
	...
	@override String get browseContent => 'Inhalte durchsuchen';
	...
	@override String get pauseDownload => 'Download pausieren';
	@override String get resumeDownload => 'Download fortsetzen';
	@override String get retryDownload => 'Download wiederholen';
	@override String get downloadComplete => 'Download abgeschlossen';
	@override String get downloadFailed => 'Download fehlgeschlagen';
	@override String get downloadCancelled => 'Download abgebrochen';
	...
	@override String get deleteConfirmTitle => 'Download löschen?';
	...
	@override String get deleteConfirmMessage => 'Die heruntergeladene Datei wird von deinem Gerät entfernt.';
	...
	@override String deletingSimple({required Object title}) => 'Lösche ${title}...';
	@override String get storageUsed => 'Speicherplatz belegt';
	@override String get availableOffline => 'Offline verfügbar';
	@override String get downloadingSeason => 'Staffel wird heruntergeladen';
	@override String get downloadingEpisode => 'Episode wird heruntergeladen';
}
...
class _StringsOfflineDe implements _StringsOfflineEn {
	...
	// Translations
	@override String get youAreOffline => 'Du bist offline';
	@override String get offlineMode => 'Offline-Modus';
	@override String get backOnline => 'Wieder online';
	@override String get showingDownloadedContent => 'Nur heruntergeladene Inhalte werden angezeigt';
	@override String get noInternetConnection => 'Keine Internetverbindung';
	@override String get serversUnreachable => 'Plex-Server nicht erreichbar';
	@override String get connectToDownload => 'Verbinde dich mit dem Internet, um Inhalte herunterzuladen';
}
...
class _StringsSettingsIt implements _StringsSettingsEn {
	...
	@override String get downloadLocationNotSupported => 'La posizione di download personalizzata non è supportata su iOS';
...
class _StringsMessagesIt implements _StringsMessagesEn {
	...
	@override String get youAreOffline => 'Sei offline';
	@override String get offlineFeatureUnavailable => 'Questa funzione richiede una connessione internet. I tuoi download e le impostazioni sono ancora disponibili.';
}
...
class _StringsDownloadsIt implements _StringsDownloadsEn {
	...
	@override String get browseContent => 'Sfoglia contenuti';
	...
	@override String get cancelDownload => 'Annulla download';
	@override String get pauseDownload => 'Metti in pausa download';
	@override String get resumeDownload => 'Riprendi download';
	@override String get retryDownload => 'Riprova download';
	@override String get downloadComplete => 'Download completato';
	@override String get downloadFailed => 'Download fallito';
	@override String get downloadCancelled => 'Download annullato';
	...
	@override String get deleteConfirmTitle => 'Eliminare il download?';
	...
	@override String get deleteConfirmMessage => 'Il file scaricato verrà rimosso dal tuo dispositivo.';
	...
	@override String deletingSimple({required Object title}) => 'Eliminazione di ${title}...';
	@override String get storageUsed => 'Spazio utilizzato';
	@override String get availableOffline => 'Disponibile offline';
	@override String get downloadingSeason => 'Download stagione in corso';
	@override String get downloadingEpisode => 'Download episodio in corso';
}
...
class _StringsOfflineIt implements _StringsOfflineEn {
	...
	// Translations
	@override String get youAreOffline => 'Sei offline';
	@override String get offlineMode => 'Modalità offline';
	@override String get backOnline => 'Di nuovo online';
	@override String get showingDownloadedContent => 'Visualizzazione solo contenuti scaricati';
	@override String get noInternetConnection => 'Nessuna connessione internet';
	@override String get serversUnreachable => 'Server Plex non raggiungibili';
	@override String get connectToDownload => 'Connettiti a internet per scaricare contenuti';
}
...
class _StringsSettingsNl implements _StringsSettingsEn {
	...
	@override String get downloadLocationNotSupported => 'Aangepaste downloadlocatie wordt niet ondersteund op iOS';
...
class _StringsMessagesNl implements _StringsMessagesEn {
	...
	@override String get youAreOffline => 'Je bent offline';
	@override String get offlineFeatureUnavailable => 'Deze functie vereist een internetverbinding. Je downloads en instellingen zijn nog steeds beschikbaar.';
}
...
class _StringsDownloadsNl implements _StringsDownloadsEn {
	...
	@override String get deleteConfirmTitle => 'Download verwijderen?';
	...
	@override String get deleteConfirmMessage => 'Het gedownloade bestand wordt van je apparaat verwijderd.';
	...
	@override String deletingSimple({required Object title}) => 'Verwijderen van ${title}...';
	@override String get storageUsed => 'Opslag gebruikt';
	@override String get availableOffline => 'Offline beschikbaar';
	@override String get downloadingSeason => 'Seizoen downloaden';
	@override String get downloadingEpisode => 'Aflevering downloaden';
}
...
class _StringsOfflineNl implements _StringsOfflineEn {
	...
	@override String get youAreOffline => 'Je bent offline';
	@override String get offlineMode => 'Offline modus';
	@override String get backOnline => 'Weer online';
	@override String get showingDownloadedContent => 'Alleen gedownloade content wordt getoond';
	@override String get noInternetConnection => 'Geen internetverbinding';
	@override String get serversUnreachable => 'Plex servers onbereikbaar';
	@override String get connectToDownload => 'Maak verbinding met internet om content te downloaden';
}
...
class _StringsSettingsSv implements _StringsSettingsEn {
	...
	@override String get downloadLocationNotSupported => 'Anpassad nedladdningsplats stöds inte på iOS';
...
class _StringsMessagesSv implements _StringsMessagesEn {
	...
	@override String get youAreOffline => 'Du är offline';
	@override String get offlineFeatureUnavailable => 'Denna funktion kräver en internetanslutning. Dina nedladdningar och inställningar är fortfarande tillgängliga.';
}
...
class _StringsDownloadsSv implements _StringsDownloadsEn {
	...
	@override String get browseContent => 'Bläddra i innehåll';
	@override String get downloading => 'Laddar ner';
	@override String get downloaded => 'Nedladdad';
	@override String get paused => 'Pausad';
	@override String get failed => 'Misslyckades';
	@override String get queued => 'I kö';
	@override String get downloadNow => 'Ladda ner';
	@override String get deleteDownload => 'Ta bort nedladdning';
	@override String get cancelDownload => 'Avbryt nedladdning';
	@override String get pauseDownload => 'Pausa nedladdning';
	@override String get resumeDownload => 'Återuppta nedladdning';
	@override String get retryDownload => 'Försök igen';
	@override String get downloadComplete => 'Nedladdning klar';
	@override String get downloadFailed => 'Nedladdning misslyckades';
	@override String get downloadCancelled => 'Nedladdning avbruten';
	...
	@override String get deleteConfirmTitle => 'Ta bort nedladdning?';
	...
	@override String get deleteConfirmMessage => 'Den nedladdade filen kommer att tas bort från din enhet.';
	...
	@override String deletingSimple({required Object title}) => 'Tar bort ${title}...';
	@override String get storageUsed => 'Lagring använd';
	@override String get availableOffline => 'Tillgänglig offline';
	@override String get downloadingSeason => 'Laddar ner säsong';
	@override String get downloadingEpisode => 'Laddar ner avsnitt';
}
...
class _StringsOfflineSv implements _StringsOfflineEn {
	...
	// Translations
	@override String get youAreOffline => 'Du är offline';
	@override String get offlineMode => 'Offline-läge';
	@override String get backOnline => 'Tillbaka online';
	@override String get showingDownloadedContent => 'Visar endast nedladdat innehåll';
	@override String get noInternetConnection => 'Ingen internetanslutning';
	@override String get serversUnreachable => 'Plex-servrar kan inte nås';
	@override String get connectToDownload => 'Anslut till internet för att ladda ner innehåll';
}
...
class _StringsSettingsZh implements _StringsSettingsEn {
	...
	@override String get downloadLocationNotSupported => 'iOS 不支持自定义下载位置';
...
class _StringsMessagesZh implements _StringsMessagesEn {
	...
	@override String get youAreOffline => '您已离线';
	@override String get offlineFeatureUnavailable => '此功能需要网络连接。您的下载内容和设置仍然可用。';
}
...
class _StringsDownloadsZh implements _StringsDownloadsEn {
	...
	@override String get browseContent => '浏览内容';
	...
	@override String get resumeDownload => '恢复下载';
	@override String get retryDownload => '重试下载';
	@override String get downloadComplete => '下载完成';
	@override String get downloadFailed => '下载失败';
	@override String get downloadCancelled => '下载已取消';
	...
	@override String get deleteConfirmTitle => '删除下载？';
	@override String deleteConfirm({required Object title}) => '确定要删除 "${title}" 吗？下载的文件将从您的设备中删除。';
	@override String get deleteConfirmMessage => '下载的文件将从您的设备中删除。';
	...
	@override String deletingSimple({required Object title}) => '正在删除 ${title}...';
	@override String get storageUsed => '已使用存储空间';
	@override String get availableOffline => '可离线使用';
	@override String get downloadingSeason => '正在下载季';
	@override String get downloadingEpisode => '正在下载剧集';
}
...
class _StringsOfflineZh implements _StringsOfflineEn {
	...
	// Translations
	@override String get youAreOffline => '您已离线';
	@override String get offlineMode => '离线模式';
	@override String get backOnline => '已恢复在线';
	@override String get showingDownloadedContent => '仅显示已下载的内容';
	@override String get noInternetConnection => '无网络连接';
	@override String get serversUnreachable => '无法连接到 Plex 服务器';
	@override String get connectToDownload => '连接网络以下载内容';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'Custom download location is not supported on iOS';
			...
			case 'messages.youAreOffline': return 'You\'re Offline';
			case 'messages.offlineFeatureUnavailable': return 'This feature requires an internet connection. Your downloads and settings are still available.';
			...
			case 'downloads.queue': return 'Queue';
			...
			case 'downloads.browseContent': return 'Browse content';
			case 'downloads.downloading': return 'Downloading';
			case 'downloads.downloaded': return 'Downloaded';
			case 'downloads.paused': return 'Paused';
			case 'downloads.failed': return 'Failed';
			...
			case 'downloads.cancelDownload': return 'Cancel download';
			case 'downloads.pauseDownload': return 'Pause download';
			case 'downloads.resumeDownload': return 'Resume download';
			case 'downloads.retryDownload': return 'Retry download';
			case 'downloads.downloadComplete': return 'Download complete';
			case 'downloads.downloadFailed': return 'Download failed';
			case 'downloads.downloadCancelled': return 'Download cancelled';
			...
			case 'downloads.deleteConfirmTitle': return 'Delete download?';
			...
			case 'downloads.deleteConfirmMessage': return 'This will remove the downloaded file from your device.';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => 'Deleting ${title}...';
			case 'downloads.storageUsed': return 'Storage used';
			case 'downloads.availableOffline': return 'Available offline';
			case 'downloads.downloadingSeason': return 'Downloading season';
			case 'downloads.downloadingEpisode': return 'Downloading episode';
			case 'offline.youAreOffline': return 'You\'re offline';
			case 'offline.offlineMode': return 'Offline mode';
			case 'offline.backOnline': return 'Back online';
			case 'offline.showingDownloadedContent': return 'Showing downloaded content only';
			case 'offline.noInternetConnection': return 'No internet connection';
			case 'offline.serversUnreachable': return 'Plex servers unreachable';
			case 'offline.connectToDownload': return 'Connect to the internet to download content';
			default: return null;
		}
	}
}
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'Benutzerdefinierter Download-Speicherort wird auf iOS nicht unterstützt';
			...
			case 'messages.youAreOffline': return 'Du bist offline';
			case 'messages.offlineFeatureUnavailable': return 'Diese Funktion erfordert eine Internetverbindung. Deine Downloads und Einstellungen sind weiterhin verfügbar.';
			...
			case 'downloads.queue': return 'Warteschlange';
			...
			case 'downloads.browseContent': return 'Inhalte durchsuchen';
			case 'downloads.downloading': return 'Wird heruntergeladen';
			case 'downloads.downloaded': return 'Heruntergeladen';
			case 'downloads.paused': return 'Pausiert';
			case 'downloads.failed': return 'Fehlgeschlagen';
			case 'downloads.queued': return 'In Warteschlange';
			case 'downloads.downloadNow': return 'Herunterladen';
			case 'downloads.deleteDownload': return 'Download löschen';
			case 'downloads.cancelDownload': return 'Download abbrechen';
			case 'downloads.pauseDownload': return 'Download pausieren';
			case 'downloads.resumeDownload': return 'Download fortsetzen';
			case 'downloads.retryDownload': return 'Download wiederholen';
			case 'downloads.downloadComplete': return 'Download abgeschlossen';
			case 'downloads.downloadFailed': return 'Download fehlgeschlagen';
			case 'downloads.downloadCancelled': return 'Download abgebrochen';
			...
			case 'downloads.deleteConfirmTitle': return 'Download löschen?';
			...
			case 'downloads.deleteConfirmMessage': return 'Die heruntergeladene Datei wird von deinem Gerät entfernt.';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => 'Lösche ${title}...';
			case 'downloads.storageUsed': return 'Speicherplatz belegt';
			case 'downloads.availableOffline': return 'Offline verfügbar';
			case 'downloads.downloadingSeason': return 'Staffel wird heruntergeladen';
			case 'downloads.downloadingEpisode': return 'Episode wird heruntergeladen';
			case 'offline.youAreOffline': return 'Du bist offline';
			case 'offline.offlineMode': return 'Offline-Modus';
			case 'offline.backOnline': return 'Wieder online';
			case 'offline.showingDownloadedContent': return 'Nur heruntergeladene Inhalte werden angezeigt';
			case 'offline.noInternetConnection': return 'Keine Internetverbindung';
			case 'offline.serversUnreachable': return 'Plex-Server nicht erreichbar';
			case 'offline.connectToDownload': return 'Verbinde dich mit dem Internet, um Inhalte herunterzuladen';
...
extension on _StringsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'La posizione di download personalizzata non è supportata su iOS';
			...
			case 'messages.youAreOffline': return 'Sei offline';
			case 'messages.offlineFeatureUnavailable': return 'Questa funzione richiede una connessione internet. I tuoi download e le impostazioni sono ancora disponibili.';
			...
			case 'downloads.queue': return 'Coda';
			...
			case 'downloads.browseContent': return 'Sfoglia contenuti';
			case 'downloads.downloading': return 'Download in corso';
			case 'downloads.downloaded': return 'Scaricato';
			case 'downloads.paused': return 'In pausa';
			case 'downloads.failed': return 'Fallito';
			case 'downloads.queued': return 'In coda';
			case 'downloads.downloadNow': return 'Scarica';
			case 'downloads.deleteDownload': return 'Elimina download';
			case 'downloads.cancelDownload': return 'Annulla download';
			case 'downloads.pauseDownload': return 'Metti in pausa download';
			case 'downloads.resumeDownload': return 'Riprendi download';
			case 'downloads.retryDownload': return 'Riprova download';
			case 'downloads.downloadComplete': return 'Download completato';
			case 'downloads.downloadFailed': return 'Download fallito';
			case 'downloads.downloadCancelled': return 'Download annullato';
			...
			case 'downloads.deleteConfirmTitle': return 'Eliminare il download?';
			...
			case 'downloads.deleteConfirmMessage': return 'Il file scaricato verrà rimosso dal tuo dispositivo.';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => 'Eliminazione di ${title}...';
			case 'downloads.storageUsed': return 'Spazio utilizzato';
			case 'downloads.availableOffline': return 'Disponibile offline';
			case 'downloads.downloadingSeason': return 'Download stagione in corso';
			case 'downloads.downloadingEpisode': return 'Download episodio in corso';
			case 'offline.youAreOffline': return 'Sei offline';
			case 'offline.offlineMode': return 'Modalità offline';
			case 'offline.backOnline': return 'Di nuovo online';
			case 'offline.showingDownloadedContent': return 'Visualizzazione solo contenuti scaricati';
			case 'offline.noInternetConnection': return 'Nessuna connessione internet';
			case 'offline.serversUnreachable': return 'Server Plex non raggiungibili';
			case 'offline.connectToDownload': return 'Connettiti a internet per scaricare contenuti';
...
extension on _StringsNl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'Aangepaste downloadlocatie wordt niet ondersteund op iOS';
			...
			case 'messages.youAreOffline': return 'Je bent offline';
			case 'messages.offlineFeatureUnavailable': return 'Deze functie vereist een internetverbinding. Je downloads en instellingen zijn nog steeds beschikbaar.';
			...
			case 'downloads.queue': return 'Wachtrij';
			...
			case 'downloads.browseContent': return 'Blader door content';
			case 'downloads.downloading': return 'Downloaden';
			case 'downloads.downloaded': return 'Gedownload';
			case 'downloads.paused': return 'Gepauzeerd';
			case 'downloads.failed': return 'Mislukt';
			case 'downloads.queued': return 'In wachtrij';
			case 'downloads.downloadNow': return 'Download';
			case 'downloads.deleteDownload': return 'Download verwijderen';
			case 'downloads.cancelDownload': return 'Download annuleren';
			case 'downloads.pauseDownload': return 'Download pauzeren';
			case 'downloads.resumeDownload': return 'Download hervatten';
			case 'downloads.retryDownload': return 'Download opnieuw proberen';
			case 'downloads.downloadComplete': return 'Download voltooid';
			...
			case 'downloads.deleteConfirmTitle': return 'Download verwijderen?';
			...
			case 'downloads.deleteConfirmMessage': return 'Het gedownloade bestand wordt van je apparaat verwijderd.';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => 'Verwijderen van ${title}...';
			case 'downloads.storageUsed': return 'Opslag gebruikt';
			case 'downloads.availableOffline': return 'Offline beschikbaar';
			case 'downloads.downloadingSeason': return 'Seizoen downloaden';
			case 'downloads.downloadingEpisode': return 'Aflevering downloaden';
			case 'offline.youAreOffline': return 'Je bent offline';
			case 'offline.offlineMode': return 'Offline modus';
			case 'offline.backOnline': return 'Weer online';
			case 'offline.showingDownloadedContent': return 'Alleen gedownloade content wordt getoond';
			case 'offline.noInternetConnection': return 'Geen internetverbinding';
			case 'offline.serversUnreachable': return 'Plex servers onbereikbaar';
			case 'offline.connectToDownload': return 'Maak verbinding met internet om content te downloaden';
...
extension on _StringsSv {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'Anpassad nedladdningsplats stöds inte på iOS';
			...
			case 'messages.youAreOffline': return 'Du är offline';
			case 'messages.offlineFeatureUnavailable': return 'Denna funktion kräver en internetanslutning. Dina nedladdningar och inställningar är fortfarande tillgängliga.';
			...
			case 'downloads.queue': return 'Kö';
			...
			case 'downloads.browseContent': return 'Bläddra i innehåll';
			case 'downloads.downloading': return 'Laddar ner';
			case 'downloads.downloaded': return 'Nedladdad';
			case 'downloads.paused': return 'Pausad';
			case 'downloads.failed': return 'Misslyckades';
			case 'downloads.queued': return 'I kö';
			case 'downloads.downloadNow': return 'Ladda ner';
			case 'downloads.deleteDownload': return 'Ta bort nedladdning';
			case 'downloads.cancelDownload': return 'Avbryt nedladdning';
			case 'downloads.pauseDownload': return 'Pausa nedladdning';
			case 'downloads.resumeDownload': return 'Återuppta nedladdning';
			case 'downloads.retryDownload': return 'Försök igen';
			case 'downloads.downloadComplete': return 'Nedladdning klar';
			case 'downloads.downloadFailed': return 'Nedladdning misslyckades';
			case 'downloads.downloadCancelled': return 'Nedladdning avbruten';
			...
			case 'downloads.deleteConfirmTitle': return 'Ta bort nedladdning?';
			...
			case 'downloads.deleteConfirmMessage': return 'Den nedladdade filen kommer att tas bort från din enhet.';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => 'Tar bort ${title}...';
			case 'downloads.storageUsed': return 'Lagring använd';
			case 'downloads.availableOffline': return 'Tillgänglig offline';
			case 'downloads.downloadingSeason': return 'Laddar ner säsong';
			case 'downloads.downloadingEpisode': return 'Laddar ner avsnitt';
			case 'offline.youAreOffline': return 'Du är offline';
			case 'offline.offlineMode': return 'Offline-läge';
			case 'offline.backOnline': return 'Tillbaka online';
			case 'offline.showingDownloadedContent': return 'Visar endast nedladdat innehåll';
			case 'offline.noInternetConnection': return 'Ingen internetanslutning';
			case 'offline.serversUnreachable': return 'Plex-servrar kan inte nås';
			case 'offline.connectToDownload': return 'Anslut till internet för att ladda ner innehåll';
...
extension on _StringsZh {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'settings.downloadLocationNotSupported': return 'iOS 不支持自定义下载位置';
			...
			case 'messages.youAreOffline': return '您已离线';
			case 'messages.offlineFeatureUnavailable': return '此功能需要网络连接。您的下载内容和设置仍然可用。';
			...
			case 'downloads.queue': return '队列';
			case 'downloads.noDownloads': return '暂无下载';
			case 'downloads.noDownloadsDescription': return '下载的内容将在此处显示以供离线观看';
			case 'downloads.browseContent': return '浏览内容';
			case 'downloads.downloading': return '下载中';
			case 'downloads.downloaded': return '已下载';
			case 'downloads.paused': return '已暂停';
			case 'downloads.failed': return '失败';
			case 'downloads.queued': return '排队中';
			case 'downloads.downloadNow': return '下载';
			case 'downloads.deleteDownload': return '删除下载';
			case 'downloads.cancelDownload': return '取消下载';
			case 'downloads.pauseDownload': return '暂停下载';
			case 'downloads.resumeDownload': return '恢复下载';
			case 'downloads.retryDownload': return '重试下载';
			case 'downloads.downloadComplete': return '下载完成';
			case 'downloads.downloadFailed': return '下载失败';
			case 'downloads.downloadCancelled': return '下载已取消';
			...
			case 'downloads.deleteConfirmTitle': return '删除下载？';
			case 'downloads.deleteConfirm': return ({required Object title}) => '确定要删除 "${title}" 吗？下载的文件将从您的设备中删除。';
			case 'downloads.deleteConfirmMessage': return '下载的文件将从您的设备中删除。';
			...
			case 'downloads.deletingSimple': return ({required Object title}) => '正在删除 ${title}...';
			case 'downloads.storageUsed': return '已使用存储空间';
			case 'downloads.availableOffline': return '可离线使用';
			case 'downloads.downloadingSeason': return '正在下载季';
			case 'downloads.downloadingEpisode': return '正在下载剧集';
			case 'offline.youAreOffline': return '您已离线';
			case 'offline.offlineMode': return '离线模式';
			case 'offline.backOnline': return '已恢复在线';
			case 'offline.showingDownloadedContent': return '仅显示已下载的内容';
			case 'offline.noInternetConnection': return '无网络连接';
			case 'offline.serversUnreachable': return '无法连接到 Plex 服务器';
			case 'offline.connectToDownload': return '连接网络以下载内容';
