...
class TranslationsSettingsEn {
	...
	/// en: 'Support Vibe'
	String get supportDeveloper => 'Support Vibe';
	...
	/// en: 'This file isn't a valid Vibe settings export'
	String get importSettingsInvalidFile => 'This file isn\'t a valid Vibe settings export';
...
class TranslationsProfilesEn {
	...
	/// en: 'Add Vibe profile'
	String get addPlezyProfile => 'Add Vibe profile';
...
class TranslationsTraktEn {
	...
	/// en: 'Vibe will stop sending events to Trakt. You can reconnect any time.'
	String get disconnectConfirmBody => 'Vibe will stop sending events to Trakt. You can reconnect any time.';
	...
	/// en: 'When you mark items watched in Vibe, mark them on Trakt.'
	String get watchedSyncDescription => 'When you mark items watched in Vibe, mark them on Trakt.';
}
...
class TranslationsTrackersEn {
	...
	/// en: 'Vibe will stop updating ${service}. Reconnect any time.'
	String disconnectConfirmBody({required Object service}) => 'Vibe will stop updating ${service}. Reconnect any time.';
...
class TranslationsCompanionRemotePairingEn {
	...
	/// en: 'Vibe devices with the same Plex account appear here'
	String get discoveryDescription => 'Vibe devices with the same Plex account appear here';
	...
	/// en: 'Open Vibe on desktop and use the same WiFi'
	String get noDevicesHint => 'Open Vibe on desktop and use the same WiFi';
	...
	/// en: 'Device not found. Make sure Vibe is running on the host.'
	String get sessionNotFound => 'Device not found. Make sure Vibe is running on the host.';
...
class TranslationsTrackersDeviceCodeEn {
	...
	/// en: 'Activate Vibe on ${service}'
	String title({required Object service}) => 'Activate Vibe on ${service}';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Support Vibe',
			...
			'settings.importSettingsInvalidFile' => 'This file isn\'t a valid Vibe settings export',
			...
			'profiles.addPlezyProfile' => 'Add Vibe profile',
			...
			'companionRemote.pairing.discoveryDescription' => 'Vibe devices with the same Plex account appear here',
			...
			'companionRemote.pairing.noDevicesHint' => 'Open Vibe on desktop and use the same WiFi',
			...
			'trakt.disconnectConfirmBody' => 'Vibe will stop sending events to Trakt. You can reconnect any time.',
			...
			'trakt.watchedSyncDescription' => 'When you mark items watched in Vibe, mark them on Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Vibe will stop updating ${service}. Reconnect any time.',
			'trackers.connectFailed' => ({required Object service}) => 'Couldn\'t connect to ${service}. Try again.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Activate Vibe on ${service}',
