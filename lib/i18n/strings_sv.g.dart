...
class _TranslationsSettingsSv extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Stöd Vibe';
	...
	@override String get importSettingsInvalidFile => 'Denna fil är inte en giltig Vibe-export';
	...
	@override String get startInFullscreenDescription => 'Öppna Vibe i helskärm vid start';
	...
	@override String get startupSectionDescription => 'Välj vilken sektion Vibe öppnar vid start';
...
class _TranslationsProfilesSv extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Lägg till Vibe-profil';
...
class _TranslationsConnectionsSv extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. Vibe använder den nåbara URL:en med lägst latens.';
}
...
class _TranslationsTraktSv extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Vibe slutar skicka händelser till Trakt. Du kan återansluta när som helst.';
	...
	@override String get watchedSyncDescription => 'När du markerar något som tittat i Vibe markeras det också på Trakt.';
}
...
class _TranslationsTrackersSv extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Vibe slutar uppdatera ${service}. Återanslut när som helst.';
...
class _TranslationsAddServerSv extends TranslationsAddServerEn {
	...
	@override String get jellyfinUrlsIntro => 'Ange en eller flera server-URL:er, separerade med kommatecken. Vibe använder den nåbara URL:en med lägst latens.';
...
class _TranslationsCompanionRemotePairingSv extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Vibe-enheter med samma Plex-konto visas här';
	...
	@override String get noDevicesHint => 'Öppna Vibe på desktop och använd samma WiFi';
	...
	@override String get sessionNotFound => 'Enhet hittades inte. Kontrollera att Vibe körs på värden.';
...
class _TranslationsTrackersDeviceCodeSv extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Aktivera Vibe på ${service}';
...
extension on TranslationsSv {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Stöd Vibe',
			...
			'settings.importSettingsInvalidFile' => 'Denna fil är inte en giltig Vibe-export',
			...
			'settings.startInFullscreenDescription' => 'Öppna Vibe i helskärm vid start',
			...
			'settings.startupSectionDescription' => 'Välj vilken sektion Vibe öppnar vid start',
			...
			'profiles.addPlezyProfile' => 'Lägg till Vibe-profil',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Lägg till eller ta bort URL:er för ${serverName}. Vibe använder den nåbara URL:en med lägst latens.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Vibe-enheter med samma Plex-konto visas här',
			...
			'companionRemote.pairing.noDevicesHint' => 'Öppna Vibe på desktop och använd samma WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Enhet hittades inte. Kontrollera att Vibe körs på värden.',
			...
			'trakt.disconnectConfirmBody' => 'Vibe slutar skicka händelser till Trakt. Du kan återansluta när som helst.',
			...
			'trakt.watchedSyncDescription' => 'När du markerar något som tittat i Vibe markeras det också på Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Vibe slutar uppdatera ${service}. Återanslut när som helst.',
			'trackers.connectFailed' => ({required Object service}) => 'Kunde inte ansluta till ${service}. Försök igen.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Aktivera Vibe på ${service}',
			...
			'addServer.jellyfinUrlsIntro' => 'Ange en eller flera server-URL:er, separerade med kommatecken. Vibe använder den nåbara URL:en med lägst latens.',
