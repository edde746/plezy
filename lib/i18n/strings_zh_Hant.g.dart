...
class TranslationsZhHant extends Translations with BaseTranslations<AppLocale, Translations> {
	...
	@override late final _TranslationsScreensZhHant screens = _TranslationsScreensZhHant._(_root);
	@override late final _TranslationsUpdateZhHant update = _TranslationsUpdateZhHant._(_root);
	...
	@override late final _TranslationsHotkeysZhHant hotkeys = _TranslationsHotkeysZhHant._(_root);
	@override late final _TranslationsFileInfoZhHant fileInfo = _TranslationsFileInfoZhHant._(_root);
	@override late final _TranslationsMediaMenuZhHant mediaMenu = _TranslationsMediaMenuZhHant._(_root);
	@override late final _TranslationsRateSheetZhHant rateSheet = _TranslationsRateSheetZhHant._(_root);
	@override late final _TranslationsAccessibilityZhHant accessibility = _TranslationsAccessibilityZhHant._(_root);
	@override late final _TranslationsTooltipsZhHant tooltips = _TranslationsTooltipsZhHant._(_root);
	@override late final _TranslationsVideoControlsZhHant videoControls = _TranslationsVideoControlsZhHant._(_root);
	@override late final _TranslationsMessagesZhHant messages = _TranslationsMessagesZhHant._(_root);
	@override late final _TranslationsSubtitlingStylingZhHant subtitlingStyling = _TranslationsSubtitlingStylingZhHant._(_root);
	@override late final _TranslationsMpvConfigZhHant mpvConfig = _TranslationsMpvConfigZhHant._(_root);
	@override late final _TranslationsDialogZhHant dialog = _TranslationsDialogZhHant._(_root);
	@override late final _TranslationsProfilesZhHant profiles = _TranslationsProfilesZhHant._(_root);
	@override late final _TranslationsConnectionsZhHant connections = _TranslationsConnectionsZhHant._(_root);
	@override late final _TranslationsDiscoverZhHant discover = _TranslationsDiscoverZhHant._(_root);
	@override late final _TranslationsErrorsZhHant errors = _TranslationsErrorsZhHant._(_root);
	@override late final _TranslationsLibrariesZhHant libraries = _TranslationsLibrariesZhHant._(_root);
	@override late final _TranslationsAboutZhHant about = _TranslationsAboutZhHant._(_root);
	@override late final _TranslationsServerSelectionZhHant serverSelection = _TranslationsServerSelectionZhHant._(_root);
	@override late final _TranslationsHubDetailZhHant hubDetail = _TranslationsHubDetailZhHant._(_root);
	@override late final _TranslationsLogsZhHant logs = _TranslationsLogsZhHant._(_root);
	@override late final _TranslationsLicensesZhHant licenses = _TranslationsLicensesZhHant._(_root);
	@override late final _TranslationsNavigationZhHant navigation = _TranslationsNavigationZhHant._(_root);
	@override late final _TranslationsExploreZhHant explore = _TranslationsExploreZhHant._(_root);
	@override late final _TranslationsLiveTvZhHant liveTv = _TranslationsLiveTvZhHant._(_root);
	@override late final _TranslationsCollectionsZhHant collections = _TranslationsCollectionsZhHant._(_root);
	@override late final _TranslationsPlaylistsZhHant playlists = _TranslationsPlaylistsZhHant._(_root);
	@override late final _TranslationsMusicZhHant music = _TranslationsMusicZhHant._(_root);
	@override late final _TranslationsWatchTogetherZhHant watchTogether = _TranslationsWatchTogetherZhHant._(_root);
	@override late final _TranslationsDownloadsZhHant downloads = _TranslationsDownloadsZhHant._(_root);
	@override late final _TranslationsShadersZhHant shaders = _TranslationsShadersZhHant._(_root);
	@override late final _TranslationsCompanionRemoteZhHant companionRemote = _TranslationsCompanionRemoteZhHant._(_root);
	@override late final _TranslationsVideoSettingsZhHant videoSettings = _TranslationsVideoSettingsZhHant._(_root);
	@override late final _TranslationsPerformanceOverlayZhHant performanceOverlay = _TranslationsPerformanceOverlayZhHant._(_root);
	@override late final _TranslationsExternalPlayerZhHant externalPlayer = _TranslationsExternalPlayerZhHant._(_root);
	@override late final _TranslationsMetadataEditZhHant metadataEdit = _TranslationsMetadataEditZhHant._(_root);
	@override late final _TranslationsMatchScreenZhHant matchScreen = _TranslationsMatchScreenZhHant._(_root);
	@override late final _TranslationsServerTasksZhHant serverTasks = _TranslationsServerTasksZhHant._(_root);
	@override late final _TranslationsTraktZhHant trakt = _TranslationsTraktZhHant._(_root);
	@override late final _TranslationsSeerrZhHant seerr = _TranslationsSeerrZhHant._(_root);
	@override late final _TranslationsServicesZhHant services = _TranslationsServicesZhHant._(_root);
	@override late final _TranslationsAddServerZhHant addServer = _TranslationsAddServerZhHant._(_root);
}
...
// Path: auth
class _TranslationsAuthZhHant extends TranslationsAuthEn {
	...
	@override String get showQRCode => '顯示 QR Code';
	@override String get authenticate => '驗證';
	@override String get authenticationTimeout => '驗證逾時。請重試。';
	@override String get scanQRToSignIn => '掃描 QR Code 登入';
...
// Path: screens
class _TranslationsScreensZhHant extends TranslationsScreensEn {
	_TranslationsScreensZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get mpvConfig => 'mpv.conf設定';
	@override String get logs => '日誌';
}

// Path: update
class _TranslationsUpdateZhHant extends TranslationsUpdateEn {
	_TranslationsUpdateZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsSettingsZhHant extends TranslationsSettingsEn {
	...
	@override String get episodePosterMode => '劇集海報樣式';
	...
	@override String get episodeAction => '劇集操作';
	@override String get episodePlay => '播放';
	@override String get episodeDetails => '開啟詳情頁';
	@override String get useGlobalHubs => '使用全域首頁版面配置';
	@override String get useGlobalHubsDescription => '顯示統一的首頁中心。否則使用各媒體庫的推薦。';
	...
	@override String get showEpisodeNumberOnCardsDescription => '在劇集卡片上顯示季和集編號';
	...
	@override String get tvFullCardLayoutDescription => '使用僅顯示圖片的 TV 卡片，並將文字疊加在上面';
	...
	@override String get hideSpoilers => '隱藏未觀看劇集的劇透內容';
	@override String get hideSpoilersDescription => '模糊未觀看劇集的縮圖與描述';
	...
	@override String get rewindOnResume => '恢復播放時微幅回退';
	@override String secondsUnit({required Object seconds}) => '${seconds} 秒';
	@override String get defaultSleepTimer => '預設睡眠定時器';
	@override String minutesUnit({required Object minutes}) => '${minutes} 分鐘';
	@override String get rememberTrackSelections => '記住每個影集/電影的軌道選擇';
	@override String get rememberTrackSelectionsDescription => '記住每個影片的音軌和字幕選擇';
	...
	@override String get clickVideoTogglesPlayback => '點擊影片可切換播放/暫停';
	@override String get clickVideoTogglesPlaybackDescription => '點擊影片直接播放/暫停，而不顯示控制面板。';
	...
	@override String get crashReporting => '崩潰報告';
	@override String get crashReportingDescription => '傳送匿名崩潰報告以協助改進應用程式';
	...
	@override String get clearCacheDescription => '清除快取的圖片與資料。再次載入內容時速度可能會變慢。';
	@override String get clearCacheSuccess => '快取清除成功';
	@override String get resetSettings => '重設設定';
	@override String get resetSettingsDescription => '恢復預設設定。此操作無法撤銷。';
	...
	@override String get exportSettingsFailed => '無法匯出設定';
	...
	@override String get importSettingsFailed => '無法匯入設定';
	...
	@override String get autoCheckUpdatesOnStartupDescription => '啟動時若有可用更新將發送通知';
	@override String get validationErrorEnterNumber => '請輸入有效的數字';
	@override String validationErrorDuration({required Object min, required Object max, required Object unit}) => '長度必須介於 ${min} 和 ${max} ${unit} 之間';
	...
	@override String get downloadLocationSelectError => '選擇資料夾失敗';
	@override String get downloadOnWifiOnly => '僅在 Wi-Fi 連線時下載';
	@override String get downloadOnWifiOnlyDescription => '使用行動數據時禁止下載';
	...
	@override String get cellularDownloadBlocked => '行動網路下已禁用下載。請使用 Wi-Fi 或更改設定。';
	...
	@override String get manageLibrariesDescription => '重新排序和隱藏媒體庫';
	@override String get companionRemoteServer => '協同遙控伺服器';
	...
	@override String get audioPassthroughDescriptionAppleTv => '將 Dolby Digital Plus (含 Atmos) 以位元流方式交由系統輸出。DTS 和 TrueHD 仍會以多聲道 PCM 播放。快進或快退時可能會有短暫無聲。';
	...
	@override String get dvConversionAutoDescription => '自動檢測裝置相容性並執行預設回退行為';
	@override String get dvConversionNativeDescription => '強制原生 DV7 並忽略 DV 轉換重試';
	...
	@override String get liveTvDefaultFavorites => '預設顯示常用頻道';
	@override String get liveTvDefaultFavoritesDescription => '開啟直播電視時僅顯示常用頻道';
...
// Path: hotkeys
class _TranslationsHotkeysZhHant extends TranslationsHotkeysEn {
	_TranslationsHotkeysZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsHotkeysActionsZhHant actions = _TranslationsHotkeysActionsZhHant._(_root);
}

// Path: fileInfo
class _TranslationsFileInfoZhHant extends TranslationsFileInfoEn {
	_TranslationsFileInfoZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: mediaMenu
class _TranslationsMediaMenuZhHant extends TranslationsMediaMenuEn {
	_TranslationsMediaMenuZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get deleteMultipleWarning => '這將會刪除所有劇集及其檔案。';
...
// Path: rateSheet
class _TranslationsRateSheetZhHant extends TranslationsRateSheetEn {
	_TranslationsRateSheetZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get favorite => '常用';
	@override String get favorited => '已加入常用';
	@override String get saved => '已儲存';
	@override String get notAvailable => '未找符合項';
	@override String get noConnectedServices => '在設定中連結外部服務後，即可在此評分。';
}

// Path: accessibility
class _TranslationsAccessibilityZhHant extends TranslationsAccessibilityEn {
	_TranslationsAccessibilityZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get tapToPlay => '點擊播放';
...
// Path: tooltips
class _TranslationsTooltipsZhHant extends TranslationsTooltipsEn {
	_TranslationsTooltipsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: videoControls
class _TranslationsVideoControlsZhHant extends TranslationsVideoControlsEn {
	_TranslationsVideoControlsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get timerActive => '定時器已啟動';
	@override String playbackWillPauseIn({required Object duration}) => '播放將在 ${duration} 後暫停';
	@override String get sleepTimerEndOfVideo => '當前影片結束時';
	@override String get sleepTimerStopAtHeader => '停止於';
	@override String get sleepTimerDurationHeader => '定時器';
	...
	@override late final _TranslationsVideoControlsPipErrorsZhHant pipErrors = _TranslationsVideoControlsPipErrorsZhHant._(_root);
	@override String get chapters => '章節';
	@override String get noChaptersAvailable => '無可用章節';
	...
	@override String get noSubtitlesAvailable => '無可用字幕';
	@override String get noAudioTracksAvailable => '無可用音軌';
	@override String get noTracksAvailable => '無可用軌道';
...
// Path: messages
class _TranslationsMessagesZhHant extends TranslationsMessagesEn {
	_TranslationsMessagesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get fileInfoNotAvailable => '檔案資訊不可用';
	...
	@override String get noDescriptionAvailable => '暫無描述';
	@override String get noProfilesAvailable => '無可用使用者';
	...
	@override String get noLogsAvailable => '無可用日誌';
	...
	@override String get noSeasonsFound => '未找到季數';
	@override String get seasonsLoadFailed => '無法載入季數';
	@override String get noEpisodesFound => '在第一季中未找到劇集';
	@override String get noEpisodesFoundGeneral => '未找到劇集';
	@override String get episodesLoadFailed => '無法載入劇集';
	@override String get noResultsFound => '未找到結果';
	@override String sleepTimerSet({required Object label}) => '睡眠定時器已設定為 ${label}';
	@override String get noItemsAvailable => '無可用項目';
	@override String get failedToCreatePlayQueueNoItems => '建立播放佇列失敗 - 沒有項目';
	...
	@override String get serverLimitBody => '伺服器錯誤 (HTTP 500)。頻寬/轉碼限制可能拒絕了此播放工作階段。請聯絡伺服器擁有者調整設定。';
...
class _TranslationsSubtitlingStylingZhHant extends TranslationsSubtitlingStylingEn {
	_TranslationsSubtitlingStylingZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: mpvConfig
class _TranslationsMpvConfigZhHant extends TranslationsMpvConfigEn {
	_TranslationsMpvConfigZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: dialog
class _TranslationsDialogZhHant extends TranslationsDialogEn {
	_TranslationsDialogZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: profiles
class _TranslationsProfilesZhHant extends TranslationsProfilesEn {
	_TranslationsProfilesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String get addPlezyProfile => '新增 Plezy 使用者設定檔';
	@override String get switchingProfile => '正在切換設定檔…';
	...
	@override String removeConnectionMessage({required Object displayName, required Object connectionLabel}) => '將移除 ${displayName} 對 ${connectionLabel} 的存取權限。其他個人設定檔仍保留。';
...
// Path: connections
class _TranslationsConnectionsZhHant extends TranslationsConnectionsEn {
	_TranslationsConnectionsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: discover
class _TranslationsDiscoverZhHant extends TranslationsDiscoverEn {
	_TranslationsDiscoverZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: libraries
class _TranslationsLibrariesZhHant extends TranslationsLibrariesEn {
	_TranslationsLibrariesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get noLibrariesFound => '未找到媒體庫';
	@override String get allLibrariesHidden => '所有媒體庫均已被隱藏';
	...
	@override String get noRecommendations => '暫無推薦';
	@override String get noCollections => '此媒體庫中沒有合集';
	@override String get noFoldersFound => '未找到資料夾';
	@override String get folders => '資料夾';
	@override late final _TranslationsLibrariesTabsZhHant tabs = _TranslationsLibrariesTabsZhHant._(_root);
	@override late final _TranslationsLibrariesGroupingsZhHant groupings = _TranslationsLibrariesGroupingsZhHant._(_root);
	@override late final _TranslationsLibrariesFilterCategoriesZhHant filterCategories = _TranslationsLibrariesFilterCategoriesZhHant._(_root);
	@override late final _TranslationsLibrariesSortLabelsZhHant sortLabels = _TranslationsLibrariesSortLabelsZhHant._(_root);
}

// Path: about
class _TranslationsAboutZhHant extends TranslationsAboutEn {
	_TranslationsAboutZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get appDescription => '一款精美的 Flutter Plex 和 Jellyfin 用戶端';
	@override String get viewLicensesDescription => '查看第三方套件的授權條款';
}

// Path: serverSelection
class _TranslationsServerSelectionZhHant extends TranslationsServerSelectionEn {
	_TranslationsServerSelectionZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String noServersFoundForAccount({required Object username, required Object email}) => '未找到 ${username} (${email}) 的伺服器';
	@override String failedToLoadServers({required Object error}) => '無法載入伺服器: ${error}';
}

// Path: hubDetail
class _TranslationsHubDetailZhHant extends TranslationsHubDetailEn {
	_TranslationsHubDetailZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get noItemsFound => '未找到項目';
}
...
// Path: licenses
class _TranslationsLicensesZhHant extends TranslationsLicensesEn {
	_TranslationsLicensesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: navigation
class _TranslationsNavigationZhHant extends TranslationsNavigationEn {
	...
	@override String get downloads => '下載';
	@override String get liveTv => '即時電視';
	@override String get explore => '探索';
}

// Path: explore
class _TranslationsExploreZhHant extends TranslationsExploreEn {
	_TranslationsExploreZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsExploreRowsZhHant rows = _TranslationsExploreRowsZhHant._(_root);
	@override late final _TranslationsExploreStatusZhHant status = _TranslationsExploreStatusZhHant._(_root);
	...
	@override String searchPrompt({required Object source}) => '在 ${source} 上搜尋電影和影集。';
	@override String get searchFailed => '搜尋失敗。請檢查網路連線後重試。';
}

// Path: liveTv
class _TranslationsLiveTvZhHant extends TranslationsLiveTvEn {
	_TranslationsLiveTvZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String get title => '即時電視';
	@override String get guide => '節目表指南';
	@override String get noChannels => '沒有可用的頻道';
	@override String get noDvr => '沒有伺服器設定 DVR 錄影機';
	@override String get serverUnavailable => '即時電視伺服器無法使用。';
	@override String get serverNotConnected => '即時電視伺服器未連線。';
	...
	@override String get favorites => '常用';
	@override String get reorderFavorites => '重新排序常用頻道';
	@override String get favoritesLoadFailed => '無法載入常用頻道。請檢查網路連線後重試。';
	@override String get joinSession => '加入目前的共同觀看';
	...
	@override String deleteRuleMessage({required Object title}) => '未來的 ${title} 劇集將不會被錄制。';
...
// Path: collections
class _TranslationsCollectionsZhHant extends TranslationsCollectionsEn {
	_TranslationsCollectionsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get empty => '合集為空';
	@override String get deleteCollection => '刪除合集';
	@override String deleteConfirm({required Object title}) => '確定要刪除 “${title}” 嗎？此操作無法回復。';
	@override String get deleted => '已刪除合集';
	@override String get deleteFailed => '刪除合集失敗';
	@override String deleteFailedWithError({required Object error}) => '刪除合集失敗：${error}';
	@override String get selectCollection => '選擇合集';
	@override String get collectionName => '合集名稱';
	@override String get enterCollectionName => '輸入合集名稱';
	@override String get addedToCollection => '已新增至合集';
	@override String get errorAddingToCollection => '新增至合集失敗';
	@override String get created => '已建立合集';
	@override String get removeFromCollection => '從合集移除';
	@override String removeFromCollectionConfirm({required Object title}) => '將 “${title}” 從此合集移除？';
	@override String get removedFromCollection => '已從合集移除';
	@override String get removeFromCollectionFailed => '從合集移除失敗';
	@override String removeFromCollectionError({required Object error}) => '從合集移除時發生錯誤：${error}';
	@override String get searchCollections => '搜尋合集...';
}
...
class _TranslationsPlaylistsZhHant extends TranslationsPlaylistsEn {
	...
	@override String get noPlaylists => '未找到播放清單';
...
// Path: music
class _TranslationsMusicZhHant extends TranslationsMusicEn {
	_TranslationsMusicZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get noLyrics => '暫無歌詞';
	@override String get sleepTimer => '睡眠定時器';
...
// Path: watchTogether
class _TranslationsWatchTogetherZhHant extends TranslationsWatchTogetherEn {
	_TranslationsWatchTogetherZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get createSession => '建立共同觀看會話';
	@override String get creating => '正在建立...';
	@override String get joinSession => '加入會話';
	...
	@override String get hostingSession => '主持共同觀看';
	@override String get inSession => '在會話中';
	@override String get sessionCode => '會話代碼';
	@override String get openSessionControls => '開啟「一起看」會話控制面版';
	@override String get copySessionCode => '複製會話代碼';
	@override String get hostControlsPlayback => '主持人控制播放';
	@override String get anyoneCanControl => '任何人均可控制播放';
	...
	@override String get endSession => '結束會話';
	@override String get leaveSession => '離開會話';
	@override String get endSessionQuestion => '結束會話？';
	@override String get leaveSessionQuestion => '離開會話？';
	@override String get endSessionConfirm => '這將為所有參與者結束此共同觀看會話。';
	@override String get leaveSessionConfirm => '您將退出此共同觀看會話。';
	@override String get endSessionConfirmOverlay => '這將為所有參與者結束觀看會話。';
	@override String get leaveSessionConfirmOverlay => '您將中斷與共同觀看會話的連線。';
	@override String get end => '結束';
	@override String get leave => '離開';
	@override String get syncing => '同步中...';
	@override String get joinWatchSession => '加入共同觀看會話';
	@override String get enterCodeHint => '輸入 5 位數代碼';
	@override String get pasteFromClipboard => '從剪貼簿貼上';
	@override String get pleaseEnterCode => '請輸入會話代碼';
	@override String get codeMustBe5Chars => '會話代碼必須為 5 個字元';
	@override String get joinInstructions => '輸入主持人的會話代碼以加入共同觀看。';
	@override String get failedToCreate => '建立會話失敗';
	@override String get failedToJoin => '加入會話失敗';
	@override String get sessionCodeCopied => '會話代碼已複製到剪貼簿';
	@override String get relayUnreachable => '無法連線至中繼伺服器。若 ISP 封裝可能導致「一起看」無法使用。';
	...
	@override String get joinCurrentPlaybackDescription => '同步至房主目前正在觀看的進度';
	...
	@override String participantSeeked({required Object name}) => '${name} 跳轉了進度';
	@override String participantBuffering({required Object name}) => '${name} 正在載入緩衝';
	...
	@override String get guestSwitchFailed => '無法切換 — 在此伺服器上未找到內容';
}

// Path: downloads
class _TranslationsDownloadsZhHant extends TranslationsDownloadsEn {
	_TranslationsDownloadsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get noDownloads => '暫無下載內容';
	...
	@override String get serverErrorBitrate => '伺服器錯誤：檔案大小可能已超過遠端位元率限制';
	...
	@override String get allEpisodesAlreadyDownloaded => '所有劇集均已下載完成';
	...
	@override String downloadedFileClickToComplete({required Object file}) => '已下載 ${file} — 點擊完成';
	@override String get partialDownloadClickToComplete => '已部分下載 — 點擊完成';
	...
	@override String get noDownloadsTree => '暫無下載內容';
	...
	@override String get allEpisodes => '所有劇集';
	...
	@override String removeSyncRuleConfirm({required Object title}) => '停止同步 “${title}”？已下載的劇集將會保留。';
	@override String syncRuleCreated({required Object count}) => '同步規則已建立 — 將保留 ${count} 個未觀看劇集';
	@override String get syncRuleUpdated => '同步規則已更新';
	@override String get syncRuleRemoved => '同步規則已刪除';
	@override String syncedNewEpisodes({required Object title, required Object count}) => '已為 ${title} 同步 ${count} 個新劇集';
	@override String get activeSyncRules => '同步規則';
	@override String get noSyncRules => '沒有同步規則';
	@override String get manageSyncRule => '管理同步';
	@override String get editEpisodeCount => '劇集數量';
...
// Path: shaders
class _TranslationsShadersZhHant extends TranslationsShadersEn {
	_TranslationsShadersZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsCompanionRemoteZhHant extends TranslationsCompanionRemoteEn {
	_TranslationsCompanionRemoteZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override late final _TranslationsCompanionRemoteSessionZhHant session = _TranslationsCompanionRemoteSessionZhHant._(_root);
	@override late final _TranslationsCompanionRemotePairingZhHant pairing = _TranslationsCompanionRemotePairingZhHant._(_root);
	@override late final _TranslationsCompanionRemoteRemoteZhHant remote = _TranslationsCompanionRemoteRemoteZhHant._(_root);
	@override late final _TranslationsCompanionRemoteErrorsZhHant errors = _TranslationsCompanionRemoteErrorsZhHant._(_root);
}

// Path: videoSettings
class _TranslationsVideoSettingsZhHant extends TranslationsVideoSettingsEn {
	_TranslationsVideoSettingsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsPerformanceOverlayZhHant extends TranslationsPerformanceOverlayEn {
	_TranslationsPerformanceOverlayZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: externalPlayer
class _TranslationsExternalPlayerZhHant extends TranslationsExternalPlayerEn {
	_TranslationsExternalPlayerZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: metadataEdit
class _TranslationsMetadataEditZhHant extends TranslationsMetadataEditEn {
	_TranslationsMetadataEditZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get episodeSorting => '劇集排序方式';
	@override String get oldestFirst => '舊的優先';
	@override String get newestFirst => '新的優先';
	...
	@override String episodesAddedPastDays({required Object count}) => '過去 ${count} 天內新增的劇集';
	@override String get deleteAfterPlaying => '播放後刪除劇集';
	...
	@override String get episodeOrdering => '劇集排序資料源';
	...
	@override String get subtitleMode => '自動開啟字幕模式';
...
// Path: matchScreen
class _TranslationsMatchScreenZhHant extends TranslationsMatchScreenEn {
	_TranslationsMatchScreenZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get search => '搜尋';
	@override String get noMatchesFound => '未找到符合的配對';
}

// Path: serverTasks
class _TranslationsServerTasksZhHant extends TranslationsServerTasksEn {
	_TranslationsServerTasksZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: trakt
class _TranslationsTraktZhHant extends TranslationsTraktEn {
	_TranslationsTraktZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get disconnectConfirmBody => 'Plezy 將停止向 Trakt 發送事件。您可以隨時重新連線。';
	@override String get scrobble => '即時同步記錄 (Scrobble)';
	@override String get scrobbleDescription => '在播放時向 Trakt 發送播放、暫停和停止等狀態。';
	@override String get watchedSync => '同步已觀看狀態';
	@override String get watchedSyncDescription => '在 Plezy 中標記為已觀看時，亦同步在 Trakt 上標記為已觀看。';
}

// Path: seerr
class _TranslationsSeerrZhHant extends TranslationsSeerrEn {
	_TranslationsSeerrZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get serverUrlHelper => '您的 Seerr 實例的連線位址';
	...
	@override String get noSignInMethods => '此 Seerr 實例未提供 Plezy 支援的登入方式。';
	@override String get instance => '實例';
	...
	@override String get request => '申請';
	@override String get request4k => '申請 4K';
	@override String get seasons => '季';
	@override String get allSeasons => '所有季度';
	...
	@override String get requestSubmitted => '申請已送出';
	@override String requestFailed({required Object error}) => '申請失敗: ${error}';
	@override String get requestsLoadFailed => '無法載入申請選項';
	@override String get nothingToRequest => '所有內容皆已可用或已被申請。';
	@override String get statusAvailable => '可用';
	@override String get statusPartiallyAvailable => '部分可用';
	@override String get statusRequested => '已申請';
	@override String get statusProcessing => '處理中';
}

// Path: services
class _TranslationsServicesZhHant extends TranslationsServicesEn {
	_TranslationsServicesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String get title => '外部服務';
	@override String get hubSubtitle => '同步觀看進度並申請新內容。';
	...
	@override late final _TranslationsServicesNamesZhHant names = _TranslationsServicesNamesZhHant._(_root);
	@override late final _TranslationsServicesDeviceCodeZhHant deviceCode = _TranslationsServicesDeviceCodeZhHant._(_root);
	@override late final _TranslationsServicesOauthProxyZhHant oauthProxy = _TranslationsServicesOauthProxyZhHant._(_root);
	@override late final _TranslationsServicesLibraryFilterZhHant libraryFilter = _TranslationsServicesLibraryFilterZhHant._(_root);
}

// Path: addServer
class _TranslationsAddServerZhHant extends TranslationsAddServerEn {
	_TranslationsAddServerZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get signInWithPlexCardSubtitleScoped => '授權一個 Plex 帳戶。Home 使用者將成為獨立的個人檔案。';
	...
	@override String connectToJellyfinCardSubtitleScoped({required Object name}) => '登入至 Jellyfin 伺服器。綁定至 ${name} 個人檔案。';
	@override String get borrowFromAnotherProfile => '從另一個使用者設定檔共用';
	@override String get borrowFromAnotherProfileSubtitle => '復用另一個個人檔案的連線資訊。受 PIN 碼保護的個人檔案需輸入 PIN 碼。';
}

// Path: hotkeys.actions
class _TranslationsHotkeysActionsZhHant extends TranslationsHotkeysActionsEn {
	_TranslationsHotkeysActionsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsVideoControlsPipErrorsZhHant extends TranslationsVideoControlsPipErrorsEn {
	_TranslationsVideoControlsPipErrorsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: libraries.tabs
class _TranslationsLibrariesTabsZhHant extends TranslationsLibrariesTabsEn {
	_TranslationsLibrariesTabsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsLibrariesGroupingsZhHant extends TranslationsLibrariesGroupingsEn {
	_TranslationsLibrariesGroupingsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsLibrariesFilterCategoriesZhHant extends TranslationsLibrariesFilterCategoriesEn {
	_TranslationsLibrariesFilterCategoriesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get favorites => '常用收藏';
}

// Path: libraries.sortLabels
class _TranslationsLibrariesSortLabelsZhHant extends TranslationsLibrariesSortLabelsEn {
	_TranslationsLibrariesSortLabelsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
// Path: explore.rows
class _TranslationsExploreRowsZhHant extends TranslationsExploreRowsEn {
	_TranslationsExploreRowsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get trendingMovies => '熱門電影';
	@override String get trendingShows => '熱門影集';
	@override String get popularMovies => '流行電影';
	@override String get popularShows => '流行影集';
	@override String get suggestedAnime => '推薦動漫';
	@override String get airingAnime => '播出中的動漫';
	@override String get popularAnime => '受歡迎的動漫';
...
// Path: explore.status
class _TranslationsExploreStatusZhHant extends TranslationsExploreStatusEn {
	_TranslationsExploreStatusZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsCompanionRemoteSessionZhHant extends TranslationsCompanionRemoteSessionEn {
	_TranslationsCompanionRemoteSessionZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsCompanionRemotePairingZhHant extends TranslationsCompanionRemotePairingEn {
	_TranslationsCompanionRemotePairingZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
	...
	@override String get noDevicesFound => '未在區域網路上找到裝置';
	@override String get noDevicesHint => '請在電腦端開啟 Plezy 並使用相同的 Wi-Fi 網路';
	...
	@override String get validationHostFormat => '格式必須為 IP:Port（例如 192.168.1.100:48632）';
	@override String get connectionTimedOut => '連線逾時。請確認兩台裝置在相同的網域連線。';
	@override String get sessionNotFound => '未找到裝置。請確認主機上已啟動 Plezy。';
...
class _TranslationsCompanionRemoteRemoteZhHant extends TranslationsCompanionRemoteRemoteEn {
	_TranslationsCompanionRemoteRemoteZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String get disconnectConfirm => '是否要中斷遠端連線會話？';
	...
	@override String get subtitles => '字幕';
	@override String get audio => '音訊';
	@override String get searchHint => '在桌面端進行搜尋...';
}

// Path: companionRemote.errors
class _TranslationsCompanionRemoteErrorsZhHant extends TranslationsCompanionRemoteErrorsEn {
	_TranslationsCompanionRemoteErrorsZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String get noNetworkInterface => '未找到網路介面';
	...
	@override String get joinTimedOut => '加入會話逾時';
...
// Path: services.names
class _TranslationsServicesNamesZhHant extends TranslationsServicesNamesEn {
	_TranslationsServicesNamesZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsServicesDeviceCodeZhHant extends TranslationsServicesDeviceCodeEn {
	_TranslationsServicesDeviceCodeZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
class _TranslationsServicesOauthProxyZhHant extends TranslationsServicesOauthProxyEn {
	_TranslationsServicesOauthProxyZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);

	final TranslationsZhHant _root; // ignore: unused_field

	// Translations
	@override String title({required Object service}) => '登入 ${service}';
	@override String get body => '掃描 QR Code，或在任何裝置上開啟該網址。';
...
class _TranslationsServicesLibraryFilterZhHant extends TranslationsServicesLibraryFilterEn {
	_TranslationsServicesLibraryFilterZhHant._(TranslationsZhHant root) : this._root = root, super.internal(root);
...
extension on TranslationsZhHant {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'auth.showQRCode' => '顯示 QR Code',
			'auth.authenticate' => '驗證',
			'auth.authenticationTimeout' => '驗證逾時。請重試。',
			'auth.scanQRToSignIn' => '掃描 QR Code 登入',
			...
			'settings.episodePosterMode' => '劇集海報樣式',
			...
			'settings.episodeAction' => '劇集操作',
			'settings.episodePlay' => '播放',
			'settings.episodeDetails' => '開啟詳情頁',
			'settings.useGlobalHubs' => '使用全域首頁版面配置',
			'settings.useGlobalHubsDescription' => '顯示統一的首頁中心。否則使用各媒體庫的推薦。',
			...
			'settings.showEpisodeNumberOnCardsDescription' => '在劇集卡片上顯示季和集編號',
			...
			'settings.tvFullCardLayoutDescription' => '使用僅顯示圖片的 TV 卡片，並將文字疊加在上面',
			...
			'settings.hideSpoilers' => '隱藏未觀看劇集的劇透內容',
			'settings.hideSpoilersDescription' => '模糊未觀看劇集的縮圖與描述',
			...
			'settings.rewindOnResume' => '恢復播放時微幅回退',
			'settings.secondsUnit' => ({required Object seconds}) => '${seconds} 秒',
			'settings.defaultSleepTimer' => '預設睡眠定時器',
			'settings.minutesUnit' => ({required Object minutes}) => '${minutes} 分鐘',
			'settings.rememberTrackSelections' => '記住每個影集/電影的軌道選擇',
			'settings.rememberTrackSelectionsDescription' => '記住每個影片的音軌和字幕選擇',
			'settings.showChapterMarkersOnTimeline' => '在進度條上顯示章節標記',
			'settings.showChapterMarkersOnTimelineDescription' => '依章節分段顯示進度條',
			'settings.clickVideoTogglesPlayback' => '點擊影片可切換播放/暫停',
			'settings.clickVideoTogglesPlaybackDescription' => '點擊影片直接播放/暫停，而不顯示控制面板。',
			...
			'settings.crashReporting' => '崩潰報告',
			'settings.crashReportingDescription' => '傳送匿名崩潰報告以協助改進應用程式',
			...
			'settings.clearCacheDescription' => '清除快取的圖片與資料。再次載入內容時速度可能會變慢。',
			'settings.clearCacheSuccess' => '快取清除成功',
			'settings.resetSettings' => '重設設定',
			'settings.resetSettingsDescription' => '恢復預設設定。此操作無法撤銷。',
			...
			'settings.exportSettingsFailed' => '無法匯出設定',
			...
			'settings.importSettingsFailed' => '無法匯入設定',
			...
			'settings.autoCheckUpdatesOnStartupDescription' => '啟動時若有可用更新將發送通知',
			'settings.validationErrorEnterNumber' => '請輸入有效的數字',
			'settings.validationErrorDuration' => ({required Object min, required Object max, required Object unit}) => '長度必須介於 ${min} 和 ${max} ${unit} 之間',
			...
			'settings.downloadLocationSelectError' => '選擇資料夾失敗',
			'settings.downloadOnWifiOnly' => '僅在 Wi-Fi 連線時下載',
			'settings.downloadOnWifiOnlyDescription' => '使用行動數據時禁止下載',
			'settings.autoRemoveWatchedDownloads' => '自動移除已觀看的下載內容',
			'settings.autoRemoveWatchedDownloadsDescription' => '自動刪除已觀看的下載影片',
			'settings.cellularDownloadBlocked' => '行動網路下已禁用下載。請使用 Wi-Fi 或更改設定。',
			...
			'settings.manageLibrariesDescription' => '重新排序和隱藏媒體庫',
			'settings.companionRemoteServer' => '協同遙控伺服器',
			...
			'settings.audioPassthroughDescriptionAppleTv' => '將 Dolby Digital Plus (含 Atmos) 以位元流方式交由系統輸出。DTS 和 TrueHD 仍會以多聲道 PCM 播放。快進或快退時可能會有短暫無聲。',
			...
			'settings.dvConversionAutoDescription' => '自動檢測裝置相容性並執行預設回退行為',
			'settings.dvConversionNativeDescription' => '強制原生 DV7 並忽略 DV 轉換重試',
			...
			'settings.liveTvDefaultFavorites' => '預設顯示常用頻道',
			'settings.liveTvDefaultFavoritesDescription' => '開啟直播電視時僅顯示常用頻道',
			...
			'mediaMenu.deleteMultipleWarning' => '這將會刪除所有劇集及其檔案。',
			...
			'rateSheet.favorite' => '常用',
			'rateSheet.favorited' => '已加入常用',
			'rateSheet.saved' => '已儲存',
			'rateSheet.notAvailable' => '未找符合項',
			...
			'videoControls.timerActive' => '定時器已啟動',
			'videoControls.playbackWillPauseIn' => ({required Object duration}) => '播放將在 ${duration} 後暫停',
			'videoControls.sleepTimerEndOfVideo' => '當前影片結束時',
			'videoControls.sleepTimerStopAtHeader' => '停止於',
			'videoControls.sleepTimerDurationHeader' => '定時器',
			...
			'videoControls.noChaptersAvailable' => '無可用章節',
			...
			'videoControls.noSubtitlesAvailable' => '無可用字幕',
			'videoControls.noAudioTracksAvailable' => '無可用音軌',
			'videoControls.noTracksAvailable' => '無可用軌道',
			...
			'messages.fileInfoNotAvailable' => '檔案資訊不可用',
			...
			'messages.noDescriptionAvailable' => '暫無描述',
			'messages.noProfilesAvailable' => '無可用使用者',
			...
			'messages.noLogsAvailable' => '無可用日誌',
			...
			'messages.noSeasonsFound' => '未找到季數',
			'messages.seasonsLoadFailed' => '無法載入季數',
			'messages.noEpisodesFound' => '在第一季中未找到劇集',
			'messages.noEpisodesFoundGeneral' => '未找到劇集',
			'messages.episodesLoadFailed' => '無法載入劇集',
			'messages.noResultsFound' => '未找到結果',
			'messages.sleepTimerSet' => ({required Object label}) => '睡眠定時器已設定為 ${label}',
			'messages.noItemsAvailable' => '無可用項目',
			'messages.failedToCreatePlayQueueNoItems' => '建立播放佇列失敗 - 沒有項目',
			...
			'messages.serverLimitBody' => '伺服器錯誤 (HTTP 500)。頻寬/轉碼限制可能拒絕了此播放工作階段。請聯絡伺服器擁有者調整設定。',
			...
			'profiles.switchingProfile' => '正在切換設定檔…',
			...
			'profiles.removeConnectionMessage' => ({required Object displayName, required Object connectionLabel}) => '將移除 ${displayName} 對 ${connectionLabel} 的存取權限。其他個人設定檔仍保留。',
			...
			'libraries.noLibrariesFound' => '未找到媒體庫',
			'libraries.allLibrariesHidden' => '所有媒體庫均已被隱藏',
			...
			'libraries.noRecommendations' => '暫無推薦',
			'libraries.noCollections' => '此媒體庫中沒有合集',
			'libraries.noFoldersFound' => '未找到資料夾',
			...
			'libraries.filterCategories.favorites' => '常用收藏',
			...
			'about.appDescription' => '一款精美的 Flutter Plex 和 Jellyfin 用戶端',
			'about.viewLicensesDescription' => '查看第三方套件的授權條款',
			'serverSelection.noServersFoundForAccount' => ({required Object username, required Object email}) => '未找到 ${username} (${email}) 的伺服器',
			...
			'explore.rows.trendingMovies' => '熱門電影',
			'explore.rows.trendingShows' => '熱門影集',
			'explore.rows.popularMovies' => '流行電影',
			'explore.rows.popularShows' => '流行影集',
			'explore.rows.suggestedAnime' => '推薦動漫',
			'explore.rows.airingAnime' => '播出中的動漫',
			'explore.rows.popularAnime' => '受歡迎的動漫',
			...
			'explore.searchPrompt' => ({required Object source}) => '在 ${source} 上搜尋電影和影集。',
			'explore.searchFailed' => '搜尋失敗。請檢查網路連線後重試。',
			'liveTv.title' => '即時電視',
			'liveTv.guide' => '節目表指南',
			'liveTv.noChannels' => '沒有可用的頻道',
			'liveTv.noDvr' => '沒有伺服器設定 DVR 錄影機',
			'liveTv.serverUnavailable' => '即時電視伺服器無法使用。',
			'liveTv.serverNotConnected' => '即時電視伺服器未連線。',
			...
			'liveTv.favorites' => '常用',
			'liveTv.reorderFavorites' => '重新排序常用頻道',
			'liveTv.favoritesLoadFailed' => '無法載入常用頻道。請檢查網路連線後重試。',
			'liveTv.joinSession' => '加入目前的共同觀看',
			...
			'liveTv.deleteRuleMessage' => ({required Object title}) => '未來的 ${title} 劇集將不會被錄制。',
			...
			'collections.empty' => '合集為空',
			'collections.deleteCollection' => '刪除合集',
			'collections.deleteConfirm' => ({required Object title}) => '確定要刪除 “${title}” 嗎？此操作無法回復。',
			'collections.deleted' => '已刪除合集',
			'collections.deleteFailed' => '刪除合集失敗',
			'collections.deleteFailedWithError' => ({required Object error}) => '刪除合集失敗：${error}',
			'collections.selectCollection' => '選擇合集',
			'collections.collectionName' => '合集名稱',
			'collections.enterCollectionName' => '輸入合集名稱',
			'collections.addedToCollection' => '已新增至合集',
			'collections.errorAddingToCollection' => '新增至合集失敗',
			'collections.created' => '已建立合集',
			'collections.removeFromCollection' => '從合集移除',
			'collections.removeFromCollectionConfirm' => ({required Object title}) => '將 “${title}” 從此合集移除？',
			'collections.removedFromCollection' => '已從合集移除',
			'collections.removeFromCollectionFailed' => '從合集移除失敗',
			'collections.removeFromCollectionError' => ({required Object error}) => '從合集移除時發生錯誤：${error}',
			'collections.searchCollections' => '搜尋合集...',
			'playlists.title' => '播放清單',
			'playlists.playlist' => '播放清單',
			'playlists.noPlaylists' => '未找到播放清單',
			...
			'watchTogether.createSession' => '建立共同觀看會話',
			'watchTogether.creating' => '正在建立...',
			'watchTogether.joinSession' => '加入會話',
			...
			'watchTogether.hostingSession' => '主持共同觀看',
			'watchTogether.inSession' => '在會話中',
			'watchTogether.sessionCode' => '會話代碼',
			'watchTogether.openSessionControls' => '開啟「一起看」會話控制面版',
			'watchTogether.copySessionCode' => '複製會話代碼',
			'watchTogether.hostControlsPlayback' => '主持人控制播放',
			'watchTogether.anyoneCanControl' => '任何人均可控制播放',
			...
			'watchTogether.endSession' => '結束會話',
			'watchTogether.leaveSession' => '離開會話',
			'watchTogether.endSessionQuestion' => '結束會話？',
			'watchTogether.leaveSessionQuestion' => '離開會話？',
			'watchTogether.endSessionConfirm' => '這將為所有參與者結束此共同觀看會話。',
			'watchTogether.leaveSessionConfirm' => '您將退出此共同觀看會話。',
			'watchTogether.endSessionConfirmOverlay' => '這將為所有參與者結束觀看會話。',
			'watchTogether.leaveSessionConfirmOverlay' => '您將中斷與共同觀看會話的連線。',
			'watchTogether.end' => '結束',
			'watchTogether.leave' => '離開',
			'watchTogether.syncing' => '同步中...',
			'watchTogether.joinWatchSession' => '加入共同觀看會話',
			'watchTogether.enterCodeHint' => '輸入 5 位數代碼',
			'watchTogether.pasteFromClipboard' => '從剪貼簿貼上',
			'watchTogether.pleaseEnterCode' => '請輸入會話代碼',
			'watchTogether.codeMustBe5Chars' => '會話代碼必須為 5 個字元',
			'watchTogether.joinInstructions' => '輸入主持人的會話代碼以加入共同觀看。',
			'watchTogether.failedToCreate' => '建立會話失敗',
			'watchTogether.failedToJoin' => '加入會話失敗',
			'watchTogether.sessionCodeCopied' => '會話代碼已複製到剪貼簿',
			'watchTogether.relayUnreachable' => '無法連線至中繼伺服器。若 ISP 封裝可能導致「一起看」無法使用。',
			'watchTogether.reconnectingToHost' => '正在重新連線至主持人...',
			'watchTogether.currentPlayback' => '目前播放內容',
			'watchTogether.joinCurrentPlayback' => '加入目前播放點',
			'watchTogether.joinCurrentPlaybackDescription' => '同步至房主目前正在觀看的進度',
			...
			'watchTogether.participantSeeked' => ({required Object name}) => '${name} 跳轉了進度',
			'watchTogether.participantBuffering' => ({required Object name}) => '${name} 正在載入緩衝',
			...
			'watchTogether.guestSwitchFailed' => '無法切換 — 在此伺服器上未找到內容',
			'downloads.title' => '下載',
			'downloads.manage' => '管理',
			...
			'downloads.serverErrorBitrate' => '伺服器錯誤：檔案大小可能已超過遠端位元率限制',
			...
			'downloads.allEpisodesAlreadyDownloaded' => '所有劇集均已下載完成',
			...
			'downloads.downloadedFileClickToComplete' => ({required Object file}) => '已下載 ${file} — 點擊完成',
			'downloads.partialDownloadClickToComplete' => '已部分下載 — 點擊完成',
			...
			'downloads.removeSyncRuleConfirm' => ({required Object title}) => '停止同步 “${title}”？已下載的劇集將會保留。',
			'downloads.syncRuleCreated' => ({required Object count}) => '同步規則已建立 — 將保留 ${count} 個未觀看劇集',
			'downloads.syncRuleUpdated' => '同步規則已更新',
			'downloads.syncRuleRemoved' => '同步規則已刪除',
			'downloads.syncedNewEpisodes' => ({required Object title, required Object count}) => '已為 ${title} 同步 ${count} 個新劇集',
			'downloads.activeSyncRules' => '同步規則',
			'downloads.noSyncRules' => '沒有同步規則',
			'downloads.manageSyncRule' => '管理同步',
			'downloads.editEpisodeCount' => '劇集數量',
			...
			'companionRemote.pairing.noDevicesFound' => '未在區域網路上找到裝置',
			'companionRemote.pairing.noDevicesHint' => '請在電腦端開啟 Plezy 並使用相同的 Wi-Fi 網路',
			...
			'companionRemote.pairing.validationHostFormat' => '格式必須為 IP:Port（例如 192.168.1.100:48632）',
			'companionRemote.pairing.connectionTimedOut' => '連線逾時。請確認兩台裝置在相同的網域連線。',
			'companionRemote.pairing.sessionNotFound' => '未找到裝置。請確認主機上已啟動 Plezy。',
			...
			'companionRemote.remote.disconnectConfirm' => '是否要中斷遠端連線會話？',
			...
			'companionRemote.remote.searchHint' => '在桌面端進行搜尋...',
			'companionRemote.errors.noNetworkInterface' => '未找到網路介面',
			...
			'companionRemote.errors.joinTimedOut' => '加入會話逾時',
			...
			'videoSettings.sleepTimer' => '睡眠定時器',
			...
			'metadataEdit.episodeSorting' => '劇集排序方式',
			'metadataEdit.oldestFirst' => '舊的優先',
			'metadataEdit.newestFirst' => '新的優先',
			'metadataEdit.keep' => '保留集數',
			'metadataEdit.allEpisodes' => '所有劇集',
			'metadataEdit.latestEpisodes' => ({required Object count}) => '最新 ${count} 集',
			'metadataEdit.latestEpisode' => '最新一集',
			'metadataEdit.episodesAddedPastDays' => ({required Object count}) => '過去 ${count} 天內新增的劇集',
			'metadataEdit.deleteAfterPlaying' => '播放後刪除劇集',
			...
			'metadataEdit.episodeOrdering' => '劇集排序資料源',
			...
			'metadataEdit.subtitleMode' => '自動開啟字幕模式',
			...
			'matchScreen.noMatchesFound' => '未找到符合的配對',
			...
			'seerr.requestSubmitted' => '申請已送出',
			'seerr.requestFailed' => ({required Object error}) => '申請失敗: ${error}',
			'seerr.requestsLoadFailed' => '無法載入申請選項',
			'seerr.nothingToRequest' => '所有內容皆已可用或已被申請。',
			'seerr.statusAvailable' => '可用',
			'seerr.statusPartiallyAvailable' => '部分可用',
			'seerr.statusRequested' => '已申請',
			'seerr.statusProcessing' => '處理中',
			'services.title' => '外部服務',
			'services.hubSubtitle' => '同步觀看進度並申請新內容。',
			...
			'services.oauthProxy.body' => '掃描 QR Code，或在任何裝置上開啟該網址。',
			...
			'addServer.signInWithPlexCardSubtitleScoped' => '授權一個 Plex 帳戶。Home 使用者將成為獨立的個人檔案。',
			'addServer.connectToJellyfinCard' => '連線至 Jellyfin',
			'addServer.connectToJellyfinCardSubtitle' => '輸入伺服器 URL、使用者名稱與密碼。',
			'addServer.connectToJellyfinCardSubtitleScoped' => ({required Object name}) => '登入至 Jellyfin 伺服器。綁定至 ${name} 個人檔案。',
			'addServer.borrowFromAnotherProfile' => '從另一個使用者設定檔共用',
			'addServer.borrowFromAnotherProfileSubtitle' => '復用另一個個人檔案的連線資訊。受 PIN 碼保護的個人檔案需輸入 PIN 碼。',
			_ => null,
		};
	}
}
