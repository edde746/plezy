...
class _Translations$videoControls$clip$pl extends Translations$videoControls$clip$en {
	_Translations$videoControls$clip$pl._(TranslationsPl root) : this._root = root, super.internal(root);
