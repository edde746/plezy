...
class _TranslationsCommonBg extends TranslationsCommonEn {
	...
	@override String get startingOfflineMode => 'Стартиране на offline режим...';
...
class _TranslationsSettingsBg extends TranslationsSettingsEn {
	...
	@override String get showHeroSection => 'Показвай Hero секция';
	...
	@override String get groupLibrariesByServerDescription => 'Групирай библиотеките в страничната лента под всеки media server.';
	...
	@override String get defaultSleepTimer => 'Sleep Timer по подразбиране';
	@override String minutesUnit({required Object minutes}) => '${minutes} минути';
	@override String get rememberTrackSelections => 'Запомняй избора на track за сериал/филм';
	@override String get rememberTrackSelectionsDescription => 'Запомняй избора на аудио и субтитри за всяко заглавие';
	@override String get showChapterMarkersOnTimeline => 'Показвай маркери на глави върху seek bar';
	@override String get showChapterMarkersOnTimelineDescription => 'Разделяй seek bar-а на сегменти по границите на главите';
	@override String get clickVideoTogglesPlayback => 'Клик върху видеото превключва play/pause';
	...
	@override String get watchTogetherRelayDescription => 'Задай собствен relay. Всички трябва да използват същия сървър.';
	...
	@override String get debugLogging => 'Debug логване';
	...
	@override String get importSettingsInvalidFile => 'Този файл не е валиден Plezy export на настройки';
	...
	@override String get autoSkipIntroDescription => 'Автоматично прескачай intro маркери след няколко секунди';
	...
	@override String get forceSkipMarkerFallback => 'Принуди fallback маркери';
	...
	@override String get introPattern => 'Шаблон за intro маркер';
	@override String get introPatternDescription => 'Regex шаблон за намиране на intro маркери в заглавия на глави';
	@override String get creditsPattern => 'Шаблон за маркер на финални надписи';
	@override String get creditsPatternDescription => 'Regex шаблон за намиране на маркери за финални надписи в заглавия на глави';
	@override String get invalidRegex => 'Невалиден regular expression';
	@override String get downloads => 'Downloads';
	@override String get downloadLocationDescription => 'Изберете къде да се съхранява изтегленото съдържание';
	@override String get downloadLocationDefault => 'По подразбиране (App Storage)';
	...
	@override String get downloadLocationChanged => 'Локацията за downloads е променена';
	@override String get downloadLocationReset => 'Локацията за downloads е върната по подразбиране';
	@override String get downloadLocationInvalid => 'Избраната папка не е writable';
	@override String get downloadLocationSelectError => 'Неуспешен избор на папка';
	@override String get downloadOnWifiOnly => 'Download само през WiFi';
	@override String get downloadOnWifiOnlyDescription => 'Предотвратявай downloads през мобилни данни';
	@override String get autoRemoveWatchedDownloads => 'Автоматично премахвай изгледаните downloads';
	@override String get autoRemoveWatchedDownloadsDescription => 'Изтривай изгледаните downloads автоматично';
	@override String get cellularDownloadBlocked => 'Downloads са блокирани през мобилни данни. Използвайте WiFi или променете настройката.';
	@override String get maxVolume => 'Максимална сила на звука';
	@override String get maxVolumeDescription => 'Позволи boost на звука над 100% за тихи медии';
	...
	@override String get autoPip => 'Автоматичен Picture-in-Picture';
	@override String get autoPipDescription => 'Влизай в picture-in-picture при напускане по време на възпроизвеждане';
	@override String get matchContentFrameRate => 'Напасване към frame rate на съдържанието';
	@override String get matchContentFrameRateDescription => 'Напасни refresh rate-а на дисплея към видео съдържанието';
	@override String get matchRefreshRate => 'Напасване на refresh rate';
	@override String get matchRefreshRateDescription => 'Напасни refresh rate-а на дисплея при цял екран';
	@override String get matchDynamicRange => 'Напасване на Dynamic Range';
	...
	@override String get tunneledPlaybackDescription => 'Използвай video tunneling. Изключете, ако HDR възпроизвеждането показва черен екран.';
	...
	@override String get dvConversionNative => 'Native / Disabled';
	...
	@override String get forceTvModeDescription => 'Принуди TV layout. За устройства, които не се разпознават автоматично. Изисква рестарт.';
	...
	@override String get autoHidePerformanceOverlay => 'Автоматично скриване на Performance Overlay';
	@override String get autoHidePerformanceOverlayDescription => 'Скривай постепенно performance overlay-а заедно с контролите за възпроизвеждане';
	...
	@override String get liveTvDefaultFavoritesDescription => 'Показвай само любими канали при отваряне на Live TV';
...
class _TranslationsFileInfoBg extends TranslationsFileInfoEn {
	...
	@override String get optimizedForStreaming => 'Оптимизирано за streaming';
...
class _TranslationsMediaMenuBg extends TranslationsMediaMenuEn {
	...
	@override String get removeFromContinueWatching => 'Премахни от Continue Watching';
...
class _TranslationsRateSheetBg extends TranslationsRateSheetEn {
	...
	@override String get noConnectedTrackers => 'Свържете tracker в Настройки, за да оценявате там.';
}
...
class _TranslationsVideoControlsBg extends TranslationsVideoControlsEn {
	...
	@override String get transcodeUnavailableFallback => 'Transcoding не е наличен — пуска се оригиналното качество';
	@override String get pipButton => 'Picture-in-Picture режим';
	...
	@override String get timelineSlider => 'Видео timeline';
	@override String get volumeSlider => 'Ниво на звука';
	@override String endsAt({required Object time}) => 'Свършва в ${time}';
	@override String get pipActive => 'Възпроизвеждане в Picture-in-Picture';
	@override String get pipFailed => 'Picture-in-picture не успя да стартира';
	@override String get screenshotSaved => 'Screenshot е запазен';
...
class _TranslationsMessagesBg extends TranslationsMessagesEn {
	...
	@override String get markedAsWatchedOffline => 'Маркирано като гледано (ще се синхронизира, когато сте online)';
	@override String get markedAsUnwatchedOffline => 'Маркирано като негледано (ще се синхронизира, когато сте online)';
	@override String autoRemovedWatchedDownload({required Object title}) => 'Автоматично премахнато: ${title}';
	@override String get removedFromContinueWatching => 'Премахнато от Continue Watching';
	...
	@override String get logsCopied => 'Логовете са копирани в clipboard';
	...
	@override String metadataRefreshing({required Object title}) => 'Опресняване на metadata за "${title}"...';
	@override String metadataRefreshStarted({required Object title}) => 'Опресняването на metadata е стартирано за "${title}"';
	@override String metadataRefreshFailed({required Object error}) => 'Неуспешно опресняване на metadata: ${error}';
	...
	@override String sleepTimerSet({required Object label}) => 'Sleep timer е зададен за ${label}';
	...
	@override String get serverLimitBody => 'Грешка на сървъра (HTTP 500). Вероятно bandwidth/transcoding лимит е отхвърлил тази сесия. Помолете собственика да го коригира.';
...
class _TranslationsMpvConfigBg extends TranslationsMpvConfigEn {
	...
	@override String get noPresets => 'Няма запазени presets';
	@override String get saveAsPreset => 'Запази като preset...';
	@override String get presetName => 'Име на preset';
	@override String get presetNameHint => 'Въведете име за този preset';
	@override String get loadPreset => 'Зареди';
	@override String get deletePreset => 'Изтрий';
	@override String get presetSaved => 'Preset-ът е запазен';
	@override String get presetLoaded => 'Preset-ът е зареден';
	@override String get presetDeleted => 'Preset-ът е изтрит';
	@override String get confirmDeletePreset => 'Сигурни ли сте, че искате да изтриете този preset?';
...
class _TranslationsProfilesBg extends TranslationsProfilesEn {
	...
	@override String get summarySingle => 'Добавете профили, за да комбинирате управлявани потребители и локални identities';
	...
	@override String get noPinSetEditOnPlex => 'Няма зададен PIN. За да изисквате PIN, редактирайте home user-а в plex.tv.';
	...
	@override String get sourceProfileMissingParentAccount => 'Изходният профил няма parent account.';
	@override String get failedToVerifyPin => 'Неуспешна проверка на PIN.';
	@override String get newProfile => 'Нов профил';
	@override String get profileNameHint => 'напр. Guests, Kids, Family Room';
...
class _TranslationsDiscoverBg extends TranslationsDiscoverEn {
	...
	@override String continueWatchingIn({required Object library}) => 'Continue Watching в ${library}';
...
class _TranslationsErrorsBg extends TranslationsErrorsEn {
	...
	@override String connectionTimeout({required Object context}) => 'Timeout на връзката при зареждане на ${context}';
	@override String get connectionFailed => 'Не може да се осъществи връзка с media server';
	@override String failedToLoad({required Object context, required Object error}) => 'Неуспешно зареждане на ${context}: ${error}';
	@override String get noClientAvailable => 'Няма наличен client';
	@override String authenticationFailed({required Object error}) => 'Удостоверяването е неуспешно: ${error}';
	@override String get couldNotLaunchUrl => 'Auth URL не може да бъде отворен';
	@override String get pleaseEnterToken => 'Моля, въведете token';
	@override String get invalidToken => 'Невалиден token';
	@override String failedToVerifyToken({required Object error}) => 'Неуспешна проверка на token: ${error}';
...
class _TranslationsLibrariesBg extends TranslationsLibrariesEn {
	...
	@override String get refreshMetadata => 'Опресни metadata';
	...
	@override String refreshMetadataConfirm({required Object title}) => 'Сигурни ли сте, че искате да опресните metadata за "${title}"?';
...
class _TranslationsAboutBg extends TranslationsAboutEn {
	...
	@override String get openSourceLicenses => 'Open Source лицензи';
	@override String versionLabel({required Object version}) => 'Версия ${version}';
	@override String get appDescription => 'Красив Plex и Jellyfin client за Flutter';
	@override String get viewLicensesDescription => 'Виж лицензите на third-party libraries';
}
...
class _TranslationsLiveTvBg extends TranslationsLiveTvEn {
	...
	@override String get reloadGuide => 'Презареди Guide';
	...
	@override String get watchLive => 'Гледай Live';
	@override String get goToLive => 'Към Live';
	...
	@override String get dvrAdminRequired => 'DVR настройките изискват admin account';
	...
	@override String get guideReloadRequested => 'Заявено е опресняване на Guide';
...
class _TranslationsWatchTogetherBg extends TranslationsWatchTogetherEn {
	...
	@override String get hostOnly => 'Само Host';
	@override String get anyone => 'Всеки';
	@override String get hostingSession => 'Hosting сесия';
	@override String get inSession => 'В сесия';
	@override String get sessionCode => 'Код на сесията';
	@override String get hostControlsPlayback => 'Host управлява възпроизвеждането';
	@override String get anyoneCanControl => 'Всеки може да управлява възпроизвеждането';
	@override String get hostControls => 'Host контроли';
	...
	@override String get youAreHost => 'Вие сте host';
	...
	@override String get endSessionConfirmOverlay => 'Това ще прекрати watch сесията за всички участници.';
	@override String get leaveSessionConfirmOverlay => 'Ще бъдете изключени от watch сесията.';
	@override String get end => 'Край';
	@override String get leave => 'Напусни';
	@override String get syncing => 'Синхронизиране...';
	@override String get joinWatchSession => 'Присъедини се към Watch сесия';
	@override String get enterCodeHint => 'Въведете 5-символен код';
	@override String get pasteFromClipboard => 'Постави от clipboard';
	...
	@override String get joinInstructions => 'Въведете кода на сесията от host-а, за да се присъедините.';
	...
	@override String get sessionCodeCopied => 'Кодът на сесията е копиран в clipboard';
	@override String get relayUnreachable => 'Relay сървърът е недостъпен. Блокиране от ISP може да пречи на Watch Together.';
	@override String get reconnectingToHost => 'Повторно свързване с host...';
	...
	@override String get joinCurrentPlaybackDescription => 'Върнете се към това, което host-ът гледа в момента';
	...
	@override String get guestSwitchUnavailable => 'Превключването не е възможно — сървърът е недостъпен за sync';
...
class _TranslationsDownloadsBg extends TranslationsDownloadsEn {
	...
	@override String get noDownloads => 'Все още няма downloads';
	@override String get noDownloadsDescription => 'Изтегленото съдържание ще се показва тук за offline гледане';
	@override String get downloadNow => 'Download';
	@override String get deleteDownload => 'Изтрий download';
	@override String get retryDownload => 'Опитай download отново';
	@override String get downloadQueued => 'Download е добавен в опашката';
	@override String get serverErrorBitrate => 'Грешка на сървъра: файлът може да надвишава remote bitrate лимита';
	@override String episodesQueued({required Object count}) => '${count} епизода са добавени в опашката за download';
	@override String get downloadDeleted => 'Download е изтрит';
	...
	@override String get noDownloadsTree => 'Няма downloads';
	...
	@override String itemsQueued({required Object count}) => '${count} елемента са добавени в опашката за download';
	@override String get keepSynced => 'Поддържай синхронизирано';
	@override String get downloadOnce => 'Download еднократно';
	@override String keepNUnwatched({required Object count}) => 'Пази ${count} негледани';
	@override String get editSyncRule => 'Редактирай sync правило';
	@override String get removeSyncRule => 'Премахни sync правило';
	@override String removeSyncRuleConfirm({required Object title}) => 'Да се спре ли sync за "${title}"? Изтеглените епизоди ще останат.';
	@override String syncRuleCreated({required Object count}) => 'Sync правилото е създадено — запазват се ${count} негледани епизода';
	@override String get syncRuleUpdated => 'Sync правилото е обновено';
	@override String get syncRuleRemoved => 'Sync правилото е премахнато';
	...
	@override String get activeSyncRules => 'Sync правила';
	@override String get noSyncRules => 'Няма sync правила';
	@override String get manageSyncRule => 'Управление на sync';
	@override String get editEpisodeCount => 'Брой епизоди';
	@override String get editSyncFilter => 'Sync филтър';
	...
	@override String get syncRuleListCreated => 'Sync правилото е създадено';
}
...
class _TranslationsShadersBg extends TranslationsShadersEn {
	...
	@override String get nvscalerDescription => 'NVIDIA image scaling за по-рязко видео';
	...
	@override String get importShader => 'Импортирай shader';
	@override String get customShaderDescription => 'Персонален GLSL shader';
	@override String get shaderImported => 'Shader-ът е импортиран';
	@override String get shaderImportFailed => 'Неуспешно импортиране на shader';
	@override String get deleteShader => 'Изтрий shader';
...
class _TranslationsExternalPlayerBg extends TranslationsExternalPlayerEn {
	...
	@override String get useExternalPlayer => 'Използвай External Player';
	...
	@override String get playerPackage => 'Име на package';
	@override String get playerUrlScheme => 'URL Scheme';
	@override String get off => 'Изключено';
	@override String get launchFailed => 'Неуспешно отваряне на external player';
	@override String appNotInstalled({required Object name}) => '${name} не е инсталиран';
	@override String get playInExternalPlayer => 'Пусни в External Player';
}
...
class _TranslationsMetadataEditBg extends TranslationsMetadataEditEn {
	...
	@override String get screenTitle => 'Редактиране на Metadata';
	...
	@override String get selectSquareArt => 'Избери Square Art';
	...
	@override String get metadataUpdated => 'Metadata е обновена';
	@override String get metadataUpdateFailed => 'Неуспешно обновяване на metadata';
	@override String get artworkUpdated => 'Artwork е обновен';
	@override String get artworkUpdateFailed => 'Неуспешно обновяване на artwork';
	@override String get noArtworkAvailable => 'Няма наличен artwork';
	@override String get notSet => 'Не е зададено';
	@override String get libraryDefault => 'По подразбиране за библиотеката';
	@override String get accountDefault => 'По подразбиране за account';
	...
	@override String get metadataLanguage => 'Език на metadata';
	...
	@override String get addTag => 'Добави tag';
...
class _TranslationsMatchScreenBg extends TranslationsMatchScreenEn {
	...
	@override String get unmatchConfirm => 'Да се изчисти ли този match? Plex ще го третира като unmatched, докато не бъде matched отново.';
	@override String get unmatchSuccess => 'Елементът е unmatched';
	@override String get unmatchFailed => 'Неуспешен unmatch на елемента';
	@override String get matchApplied => 'Match е приложен';
	@override String get matchFailed => 'Неуспешно прилагане на match';
	@override String get titleHint => 'Заглавие';
	@override String get yearHint => 'Година';
	@override String get search => 'Търсене';
	@override String get noMatchesFound => 'Няма намерени matches';
}
...
class _TranslationsServerTasksBg extends TranslationsServerTasksEn {
	...
	@override String get failedToLoad => 'Неуспешно зареждане на tasks';
	@override String get noTasks => 'Няма изпълняващи се tasks';
}
...
class _TranslationsTraktBg extends TranslationsTraktEn {
	...
	@override String get disconnectConfirm => 'Да се прекъсне ли Trakt account?';
	...
	@override String get scrobbleDescription => 'Изпращай play, pause и stop събития към Trakt по време на възпроизвеждане.';
...
class _TranslationsAddServerBg extends TranslationsAddServerEn {
	...
	@override String get jellyfinUrlIntro => 'Въведете URL на сървъра, напр. `https://jellyfin.example.com`.';
	@override String get serverUrl => 'URL на сървър';
	...
	@override String get duplicatePlexAccount => 'Вече сте влезли в Plex. Излезте, за да смените account.';
	@override String failedToRegisterAccount({required Object error}) => 'Неуспешна регистрация на account: ${error}';
	@override String get enterJellyfinUrlError => 'Въведете URL на вашия Jellyfin сървър';
	...
	@override String get addConnectionIntroGlobal => 'Добавете друг media server. Plex и Jellyfin се показват заедно в Home.';
	...
	@override String get signInWithPlexCardSubtitle => 'Authorize това устройство. Споделените сървъри се добавят.';
	@override String get signInWithPlexCardSubtitleScoped => 'Authorize Plex account. Home users стават профили.';
	@override String get connectToJellyfinCard => 'Свързване с Jellyfin';
	@override String get connectToJellyfinCardSubtitle => 'Въведете URL на сървъра, потребителско име и парола.';
...
class _TranslationsHotkeysActionsBg extends TranslationsHotkeysActionsEn {
	...
	@override String get audioTrackNext => 'Следващ аудио track';
	@override String get subtitleTrackNext => 'Следващ subtitle track';
	...
	@override String get shaderToggle => 'Превключи shaders';
	@override String get skipMarker => 'Прескочи интро/финални надписи';
	@override String get screenshot => 'Направи screenshot';
}
...
class _TranslationsVideoControlsPipErrorsBg extends TranslationsVideoControlsPipErrorsEn {
	...
	@override String get permissionDisabled => 'Picture-in-picture е изключен. Включете го в системните настройки.';
	@override String get notSupported => 'Устройството не поддържа picture-in-picture режим';
	@override String get voSwitchFailed => 'Неуспешна смяна на video output за picture-in-picture';
	@override String get failed => 'Picture-in-picture не успя да стартира';
...
class _TranslationsLibrariesSortLabelsBg extends TranslationsLibrariesSortLabelsEn {
	...
	@override String get releaseDate => 'Дата на излизане';
	@override String get rating => 'Рейтинг';
	@override String get communityRating => 'Community Rating';
	@override String get criticRating => 'Critic Rating';
	...
	@override String get runtime => 'Runtime';
	@override String get officialRating => 'Official Rating';
...
class _TranslationsCompanionRemoteSessionBg extends TranslationsCompanionRemoteSessionEn {
	...
	// Translations
	@override String get startingServer => 'Стартиране на remote server...';
	@override String get failedToCreate => 'Неуспешно стартиране на remote server:';
	@override String get hostAddress => 'Host адрес';
	@override String get connected => 'Свързан';
	@override String get serverRunning => 'Remote server активен';
	@override String get serverStopped => 'Remote server спрян';
...
class _TranslationsCompanionRemotePairingBg extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Plezy устройства със същия Plex account се показват тук';
	...
	@override String get noDevicesHint => 'Отворете Plezy на desktop и използвайте същия WiFi';
	@override String get availableDevices => 'Налични устройства';
	@override String get manualConnection => 'Ръчно свързване';
	@override String get cryptoInitFailed => 'Не може да се стартира secure connection. Първо влезте в Plex.';
	@override String get validationHostRequired => 'Моля, въведете host адрес';
	...
	@override String get sessionNotFound => 'Устройството не е намерено. Уверете се, че Plezy работи на host-а.';
	@override String get authFailed => 'Удостоверяването е неуспешно. Двете устройства трябва да използват същия Plex account.';
...
class _TranslationsCompanionRemoteRemoteBg extends TranslationsCompanionRemoteRemoteEn {
	...
	// Translations
	@override String get disconnectConfirm => 'Искате ли да прекъснете връзката с remote сесията?';
	...
	@override String get subtitles => 'Субтитри';
	@override String get audio => 'Аудио';
	@override String get searchHint => 'Търсене на desktop...';
}
...
class _TranslationsTrackersDeviceCodeBg extends TranslationsTrackersDeviceCodeEn {
	...
	@override String get waitingForAuthorization => 'Изчакване на authorization…';
...
class _TranslationsTrackersOauthProxyBg extends TranslationsTrackersOauthProxyEn {
	...
	@override String get urlCopied => 'URL е копиран';
}
...
extension on TranslationsBg {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'common.startingOfflineMode' => 'Стартиране на offline режим...',
			...
			'settings.showHeroSection' => 'Показвай Hero секция',
			...
			'settings.groupLibrariesByServerDescription' => 'Групирай библиотеките в страничната лента под всеки media server.',
			...
			'settings.defaultSleepTimer' => 'Sleep Timer по подразбиране',
			'settings.minutesUnit' => ({required Object minutes}) => '${minutes} минути',
			'settings.rememberTrackSelections' => 'Запомняй избора на track за сериал/филм',
			'settings.rememberTrackSelectionsDescription' => 'Запомняй избора на аудио и субтитри за всяко заглавие',
			'settings.showChapterMarkersOnTimeline' => 'Показвай маркери на глави върху seek bar',
			'settings.showChapterMarkersOnTimelineDescription' => 'Разделяй seek bar-а на сегменти по границите на главите',
			'settings.clickVideoTogglesPlayback' => 'Клик върху видеото превключва play/pause',
			...
			'settings.watchTogetherRelayDescription' => 'Задай собствен relay. Всички трябва да използват същия сървър.',
			...
			'settings.debugLogging' => 'Debug логване',
			...
			'settings.importSettingsInvalidFile' => 'Този файл не е валиден Plezy export на настройки',
			...
			'settings.autoSkipIntroDescription' => 'Автоматично прескачай intro маркери след няколко секунди',
			...
			'settings.forceSkipMarkerFallback' => 'Принуди fallback маркери',
			...
			'settings.introPattern' => 'Шаблон за intro маркер',
			'settings.introPatternDescription' => 'Regex шаблон за намиране на intro маркери в заглавия на глави',
			'settings.creditsPattern' => 'Шаблон за маркер на финални надписи',
			'settings.creditsPatternDescription' => 'Regex шаблон за намиране на маркери за финални надписи в заглавия на глави',
			'settings.invalidRegex' => 'Невалиден regular expression',
			'settings.downloads' => 'Downloads',
			'settings.downloadLocationDescription' => 'Изберете къде да се съхранява изтегленото съдържание',
			'settings.downloadLocationDefault' => 'По подразбиране (App Storage)',
			...
			'settings.downloadLocationChanged' => 'Локацията за downloads е променена',
			'settings.downloadLocationReset' => 'Локацията за downloads е върната по подразбиране',
			'settings.downloadLocationInvalid' => 'Избраната папка не е writable',
			'settings.downloadLocationSelectError' => 'Неуспешен избор на папка',
			'settings.downloadOnWifiOnly' => 'Download само през WiFi',
			'settings.downloadOnWifiOnlyDescription' => 'Предотвратявай downloads през мобилни данни',
			'settings.autoRemoveWatchedDownloads' => 'Автоматично премахвай изгледаните downloads',
			'settings.autoRemoveWatchedDownloadsDescription' => 'Изтривай изгледаните downloads автоматично',
			'settings.cellularDownloadBlocked' => 'Downloads са блокирани през мобилни данни. Използвайте WiFi или променете настройката.',
			'settings.maxVolume' => 'Максимална сила на звука',
			'settings.maxVolumeDescription' => 'Позволи boost на звука над 100% за тихи медии',
			...
			'settings.autoPip' => 'Автоматичен Picture-in-Picture',
			'settings.autoPipDescription' => 'Влизай в picture-in-picture при напускане по време на възпроизвеждане',
			'settings.matchContentFrameRate' => 'Напасване към frame rate на съдържанието',
			'settings.matchContentFrameRateDescription' => 'Напасни refresh rate-а на дисплея към видео съдържанието',
			'settings.matchRefreshRate' => 'Напасване на refresh rate',
			'settings.matchRefreshRateDescription' => 'Напасни refresh rate-а на дисплея при цял екран',
			'settings.matchDynamicRange' => 'Напасване на Dynamic Range',
			...
			'settings.tunneledPlaybackDescription' => 'Използвай video tunneling. Изключете, ако HDR възпроизвеждането показва черен екран.',
			...
			'settings.forceTvModeDescription' => 'Принуди TV layout. За устройства, които не се разпознават автоматично. Изисква рестарт.',
			...
			'settings.autoHidePerformanceOverlay' => 'Автоматично скриване на Performance Overlay',
			'settings.autoHidePerformanceOverlayDescription' => 'Скривай постепенно performance overlay-а заедно с контролите за възпроизвеждане',
			...
			'settings.liveTvDefaultFavoritesDescription' => 'Показвай само любими канали при отваряне на Live TV',
			...
			'hotkeys.actions.audioTrackNext' => 'Следващ аудио track',
			'hotkeys.actions.subtitleTrackNext' => 'Следващ subtitle track',
			...
			'hotkeys.actions.shaderToggle' => 'Превключи shaders',
			'hotkeys.actions.skipMarker' => 'Прескочи интро/финални надписи',
			'hotkeys.actions.screenshot' => 'Направи screenshot',
			...
			'fileInfo.optimizedForStreaming' => 'Оптимизирано за streaming',
			'fileInfo.has64bitOffsets' => '64-bit offsets',
			'mediaMenu.markAsWatched' => 'Маркирай като гледано',
			'mediaMenu.markAsUnwatched' => 'Маркирай като негледано',
			'mediaMenu.removeFromContinueWatching' => 'Премахни от Continue Watching',
			...
			'rateSheet.noConnectedTrackers' => 'Свържете tracker в Настройки, за да оценявате там.',
			...
			'videoControls.transcodeUnavailableFallback' => 'Transcoding не е наличен — пуска се оригиналното качество',
			'videoControls.pipButton' => 'Picture-in-Picture режим',
			...
			'videoControls.timelineSlider' => 'Видео timeline',
			'videoControls.volumeSlider' => 'Ниво на звука',
			'videoControls.endsAt' => ({required Object time}) => 'Свършва в ${time}',
			'videoControls.pipActive' => 'Възпроизвеждане в Picture-in-Picture',
			'videoControls.pipFailed' => 'Picture-in-picture не успя да стартира',
			'videoControls.screenshotSaved' => 'Screenshot е запазен',
			...
			'videoControls.pipErrors.permissionDisabled' => 'Picture-in-picture е изключен. Включете го в системните настройки.',
			'videoControls.pipErrors.notSupported' => 'Устройството не поддържа picture-in-picture режим',
			'videoControls.pipErrors.voSwitchFailed' => 'Неуспешна смяна на video output за picture-in-picture',
			'videoControls.pipErrors.failed' => 'Picture-in-picture не успя да стартира',
			...
			'messages.markedAsWatchedOffline' => 'Маркирано като гледано (ще се синхронизира, когато сте online)',
			'messages.markedAsUnwatchedOffline' => 'Маркирано като негледано (ще се синхронизира, когато сте online)',
			'messages.autoRemovedWatchedDownload' => ({required Object title}) => 'Автоматично премахнато: ${title}',
			'messages.removedFromContinueWatching' => 'Премахнато от Continue Watching',
			...
			'messages.logsCopied' => 'Логовете са копирани в clipboard',
			...
			'messages.metadataRefreshing' => ({required Object title}) => 'Опресняване на metadata за "${title}"...',
			'messages.metadataRefreshStarted' => ({required Object title}) => 'Опресняването на metadata е стартирано за "${title}"',
			'messages.metadataRefreshFailed' => ({required Object error}) => 'Неуспешно опресняване на metadata: ${error}',
			...
			'messages.sleepTimerSet' => ({required Object label}) => 'Sleep timer е зададен за ${label}',
			...
			'messages.serverLimitBody' => 'Грешка на сървъра (HTTP 500). Вероятно bandwidth/transcoding лимит е отхвърлил тази сесия. Помолете собственика да го коригира.',
			...
			'mpvConfig.noPresets' => 'Няма запазени presets',
			'mpvConfig.saveAsPreset' => 'Запази като preset...',
			'mpvConfig.presetName' => 'Име на preset',
			'mpvConfig.presetNameHint' => 'Въведете име за този preset',
			'mpvConfig.loadPreset' => 'Зареди',
			'mpvConfig.deletePreset' => 'Изтрий',
			'mpvConfig.presetSaved' => 'Preset-ът е запазен',
			'mpvConfig.presetLoaded' => 'Preset-ът е зареден',
			'mpvConfig.presetDeleted' => 'Preset-ът е изтрит',
			'mpvConfig.confirmDeletePreset' => 'Сигурни ли сте, че искате да изтриете този preset?',
			...
			'profiles.summarySingle' => 'Добавете профили, за да комбинирате управлявани потребители и локални identities',
			...
			'profiles.noPinSetEditOnPlex' => 'Няма зададен PIN. За да изисквате PIN, редактирайте home user-а в plex.tv.',
			...
			'profiles.sourceProfileMissingParentAccount' => 'Изходният профил няма parent account.',
			'profiles.failedToVerifyPin' => 'Неуспешна проверка на PIN.',
			'profiles.newProfile' => 'Нов профил',
			'profiles.profileNameHint' => 'напр. Guests, Kids, Family Room',
			...
			'discover.continueWatchingIn' => ({required Object library}) => 'Continue Watching в ${library}',
			...
			'errors.connectionTimeout' => ({required Object context}) => 'Timeout на връзката при зареждане на ${context}',
			'errors.connectionFailed' => 'Не може да се осъществи връзка с media server',
			'errors.failedToLoad' => ({required Object context, required Object error}) => 'Неуспешно зареждане на ${context}: ${error}',
			'errors.noClientAvailable' => 'Няма наличен client',
			'errors.authenticationFailed' => ({required Object error}) => 'Удостоверяването е неуспешно: ${error}',
			'errors.couldNotLaunchUrl' => 'Auth URL не може да бъде отворен',
			'errors.pleaseEnterToken' => 'Моля, въведете token',
			'errors.invalidToken' => 'Невалиден token',
			'errors.failedToVerifyToken' => ({required Object error}) => 'Неуспешна проверка на token: ${error}',
			...
			'libraries.refreshMetadata' => 'Опресни metadata',
			...
			'libraries.refreshMetadataConfirm' => ({required Object title}) => 'Сигурни ли сте, че искате да опресните metadata за "${title}"?',
			...
			'about.title' => 'Относно',
			'about.openSourceLicenses' => 'Open Source лицензи',
			'about.versionLabel' => ({required Object version}) => 'Версия ${version}',
			'about.appDescription' => 'Красив Plex и Jellyfin client за Flutter',
			'about.viewLicensesDescription' => 'Виж лицензите на third-party libraries',
			...
			'liveTv.live' => 'LIVE',
			'liveTv.reloadGuide' => 'Презареди Guide',
			'liveTv.now' => 'Сега',
			'liveTv.today' => 'Днес',
			...
			'liveTv.watchLive' => 'Гледай Live',
			'liveTv.goToLive' => 'Към Live',
			'liveTv.record' => 'Запис',
			...
			'liveTv.dvrAdminRequired' => 'DVR настройките изискват admin account',
			...
			'liveTv.guideReloadRequested' => 'Заявено е опресняване на Guide',
			...
			'watchTogether.endSessionConfirmOverlay' => 'Това ще прекрати watch сесията за всички участници.',
			'watchTogether.leaveSessionConfirmOverlay' => 'Ще бъдете изключени от watch сесията.',
			'watchTogether.end' => 'Край',
			'watchTogether.leave' => 'Напусни',
			'watchTogether.syncing' => 'Синхронизиране...',
			'watchTogether.joinWatchSession' => 'Присъедини се към Watch сесия',
			'watchTogether.enterCodeHint' => 'Въведете 5-символен код',
			'watchTogether.pasteFromClipboard' => 'Постави от clipboard',
			...
			'watchTogether.joinInstructions' => 'Въведете кода на сесията от host-а, за да се присъедините.',
			'watchTogether.failedToCreate' => 'Неуспешно създаване на сесия',
			'watchTogether.failedToJoin' => 'Неуспешно присъединяване към сесия',
			'watchTogether.sessionCodeCopied' => 'Кодът на сесията е копиран в clipboard',
			'watchTogether.relayUnreachable' => 'Relay сървърът е недостъпен. Блокиране от ISP може да пречи на Watch Together.',
			'watchTogether.reconnectingToHost' => 'Повторно свързване с host...',
			...
			'watchTogether.joinCurrentPlaybackDescription' => 'Върнете се към това, което host-ът гледа в момента',
			...
			'watchTogether.guestSwitchUnavailable' => 'Превключването не е възможно — сървърът е недостъпен за sync',
			...
			'downloads.noDownloads' => 'Все още няма downloads',
			'downloads.noDownloadsDescription' => 'Изтегленото съдържание ще се показва тук за offline гледане',
			'downloads.downloadNow' => 'Download',
			'downloads.deleteDownload' => 'Изтрий download',
			'downloads.retryDownload' => 'Опитай download отново',
			'downloads.downloadQueued' => 'Download е добавен в опашката',
			'downloads.serverErrorBitrate' => 'Грешка на сървъра: файлът може да надвишава remote bitrate лимита',
			'downloads.episodesQueued' => ({required Object count}) => '${count} епизода са добавени в опашката за download',
			'downloads.downloadDeleted' => 'Download е изтрит',
			...
			'downloads.noDownloadsTree' => 'Няма downloads',
			...
			'downloads.itemsQueued' => ({required Object count}) => '${count} елемента са добавени в опашката за download',
			'downloads.keepSynced' => 'Поддържай синхронизирано',
			'downloads.downloadOnce' => 'Download еднократно',
			'downloads.keepNUnwatched' => ({required Object count}) => 'Пази ${count} негледани',
			'downloads.editSyncRule' => 'Редактирай sync правило',
			'downloads.removeSyncRule' => 'Премахни sync правило',
			'downloads.removeSyncRuleConfirm' => ({required Object title}) => 'Да се спре ли sync за "${title}"? Изтеглените епизоди ще останат.',
			'downloads.syncRuleCreated' => ({required Object count}) => 'Sync правилото е създадено — запазват се ${count} негледани епизода',
			'downloads.syncRuleUpdated' => 'Sync правилото е обновено',
			'downloads.syncRuleRemoved' => 'Sync правилото е премахнато',
			'downloads.syncedNewEpisodes' => ({required Object count, required Object title}) => 'Синхронизирани са ${count} нови епизода за ${title}',
			'downloads.activeSyncRules' => 'Sync правила',
			'downloads.noSyncRules' => 'Няма sync правила',
			'downloads.manageSyncRule' => 'Управление на sync',
			'downloads.editEpisodeCount' => 'Брой епизоди',
			'downloads.editSyncFilter' => 'Sync филтър',
			...
			'downloads.syncRuleListCreated' => 'Sync правилото е създадено',
			'shaders.title' => 'Shaders',
			'shaders.noShaderDescription' => 'Без видео подобрение',
			'shaders.nvscalerDescription' => 'NVIDIA image scaling за по-рязко видео',
			...
			'shaders.mode' => 'Режим',
			'shaders.importShader' => 'Импортирай shader',
			'shaders.customShaderDescription' => 'Персонален GLSL shader',
			'shaders.shaderImported' => 'Shader-ът е импортиран',
			'shaders.shaderImportFailed' => 'Неуспешно импортиране на shader',
			'shaders.deleteShader' => 'Изтрий shader',
			...
			'companionRemote.session.startingServer' => 'Стартиране на remote server...',
			'companionRemote.session.failedToCreate' => 'Неуспешно стартиране на remote server:',
			'companionRemote.session.hostAddress' => 'Host адрес',
			'companionRemote.session.connected' => 'Свързан',
			'companionRemote.session.serverRunning' => 'Remote server активен',
			'companionRemote.session.serverStopped' => 'Remote server спрян',
			...
			'companionRemote.pairing.discoveryDescription' => 'Plezy устройства със същия Plex account се показват тук',
			...
			'companionRemote.pairing.noDevicesHint' => 'Отворете Plezy на desktop и използвайте същия WiFi',
			'companionRemote.pairing.availableDevices' => 'Налични устройства',
			'companionRemote.pairing.manualConnection' => 'Ръчно свързване',
			'companionRemote.pairing.cryptoInitFailed' => 'Не може да се стартира secure connection. Първо влезте в Plex.',
			'companionRemote.pairing.validationHostRequired' => 'Моля, въведете host адрес',
			...
			'companionRemote.pairing.sessionNotFound' => 'Устройството не е намерено. Уверете се, че Plezy работи на host-а.',
			'companionRemote.pairing.authFailed' => 'Удостоверяването е неуспешно. Двете устройства трябва да използват същия Plex account.',
			'companionRemote.pairing.failedToConnect' => ({required Object error}) => 'Неуспешно свързване: ${error}',
			'companionRemote.remote.disconnectConfirm' => 'Искате ли да прекъснете връзката с remote сесията?',
			...
			'companionRemote.remote.searchHint' => 'Търсене на desktop...',
			...
			'externalPlayer.useExternalPlayer' => 'Използвай External Player',
			...
			'externalPlayer.playerPackage' => 'Име на package',
			'externalPlayer.playerUrlScheme' => 'URL Scheme',
			'externalPlayer.off' => 'Изключено',
			'externalPlayer.launchFailed' => 'Неуспешно отваряне на external player',
			'externalPlayer.appNotInstalled' => ({required Object name}) => '${name} не е инсталиран',
			'externalPlayer.playInExternalPlayer' => 'Пусни в External Player',
			'metadataEdit.editMetadata' => 'Редактирай...',
			'metadataEdit.screenTitle' => 'Редактиране на Metadata',
			...
			'metadataEdit.selectSquareArt' => 'Избери Square Art',
			...
			'metadataEdit.metadataUpdated' => 'Metadata е обновена',
			'metadataEdit.metadataUpdateFailed' => 'Неуспешно обновяване на metadata',
			'metadataEdit.artworkUpdated' => 'Artwork е обновен',
			'metadataEdit.artworkUpdateFailed' => 'Неуспешно обновяване на artwork',
			'metadataEdit.noArtworkAvailable' => 'Няма наличен artwork',
			'metadataEdit.notSet' => 'Не е зададено',
			'metadataEdit.libraryDefault' => 'По подразбиране за библиотеката',
			'metadataEdit.accountDefault' => 'По подразбиране за account',
			...
			'metadataEdit.metadataLanguage' => 'Език на metadata',
			...
			'metadataEdit.addTag' => 'Добави tag',
			...
			'matchScreen.unmatchConfirm' => 'Да се изчисти ли този match? Plex ще го третира като unmatched, докато не бъде matched отново.',
			'matchScreen.unmatchSuccess' => 'Елементът е unmatched',
			'matchScreen.unmatchFailed' => 'Неуспешен unmatch на елемента',
			'matchScreen.matchApplied' => 'Match е приложен',
			'matchScreen.matchFailed' => 'Неуспешно прилагане на match',
			'matchScreen.titleHint' => 'Заглавие',
			'matchScreen.yearHint' => 'Година',
			'matchScreen.search' => 'Търсене',
			'matchScreen.noMatchesFound' => 'Няма намерени matches',
			'serverTasks.title' => 'Server Tasks',
			'serverTasks.failedToLoad' => 'Неуспешно зареждане на tasks',
			'serverTasks.noTasks' => 'Няма изпълняващи се tasks',
			'trakt.title' => 'Trakt',
			'trakt.connected' => 'Свързан',
			'trakt.connectedAs' => ({required Object username}) => 'Свързан като @${username}',
			'trakt.disconnectConfirm' => 'Да се прекъсне ли Trakt account?',
			...
			'trakt.scrobbleDescription' => 'Изпращай play, pause и stop събития към Trakt по време на възпроизвеждане.',
			...
			'trackers.deviceCode.waitingForAuthorization' => 'Изчакване на authorization…',
			...
			'trackers.oauthProxy.urlCopied' => 'URL е копиран',
			...
			'addServer.jellyfinUrlIntro' => 'Въведете URL на сървъра, напр. `https://jellyfin.example.com`.',
			'addServer.serverUrl' => 'URL на сървър',
			...
			'addServer.duplicatePlexAccount' => 'Вече сте влезли в Plex. Излезте, за да смените account.',
			'addServer.failedToRegisterAccount' => ({required Object error}) => 'Неуспешна регистрация на account: ${error}',
			'addServer.enterJellyfinUrlError' => 'Въведете URL на вашия Jellyfin сървър',
			'addServer.addConnectionTitle' => 'Добави връзка',
			'addServer.addConnectionTitleScoped' => ({required Object name}) => 'Добави към ${name}',
			'addServer.addConnectionIntroGlobal' => 'Добавете друг media server. Plex и Jellyfin се показват заедно в Home.',
			...
			'addServer.signInWithPlexCardSubtitle' => 'Authorize това устройство. Споделените сървъри се добавят.',
			'addServer.signInWithPlexCardSubtitleScoped' => 'Authorize Plex account. Home users стават профили.',
			'addServer.connectToJellyfinCard' => 'Свързване с Jellyfin',
			'addServer.connectToJellyfinCardSubtitle' => 'Въведете URL на сървъра, потребителско име и парола.',
