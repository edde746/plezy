...
class _TranslationsSettingsBg extends TranslationsSettingsEn {
	...
	@override String get supportDeveloper => 'Подкрепи Vibe';
	...
	@override String get importSettingsInvalidFile => 'Този файл не е валиден експорт на настройки от Vibe';
	...
	@override String get startInFullscreenDescription => 'Отваряй Vibe в режим цял екран при стартиране';
	...
	@override String get startupSectionDescription => 'Изберете кой раздел да отваря Vibe при стартиране';
...
class _TranslationsProfilesBg extends TranslationsProfilesEn {
	...
	// Translations
	@override String get addPlezyProfile => 'Добави Vibe профил';
...
class _TranslationsConnectionsBg extends TranslationsConnectionsEn {
	...
	@override String editJellyfinIntro({required Object serverName}) => 'Добавете или премахнете URL адреси за ${serverName}. Vibe ще използва достъпния URL адрес с най-ниска латентност.';
}
...
class _TranslationsTraktBg extends TranslationsTraktEn {
	...
	@override String get disconnectConfirmBody => 'Vibe ще спре да изпраща събития към Trakt. Можете да се свържете отново по всяко време.';
	...
	@override String get watchedSyncDescription => 'Когато маркирате елементи като гледани в Vibe, маркирай ги и в Trakt.';
}
...
class _TranslationsTrackersBg extends TranslationsTrackersEn {
	...
	@override String disconnectConfirmBody({required Object service}) => 'Vibe ще спре да обновява ${service}. Можете да се свържете отново по всяко време.';
...
class _TranslationsCompanionRemotePairingBg extends TranslationsCompanionRemotePairingEn {
	...
	// Translations
	@override String get discoveryDescription => 'Vibe устройства със същия Plex акаунт се показват тук';
	...
	@override String get noDevicesHint => 'Отворете Vibe на настолен компютър и използвайте същия WiFi';
	...
	@override String get sessionNotFound => 'Устройството не е намерено. Уверете се, че Vibe работи на хоста.';
...
class _TranslationsTrackersDeviceCodeBg extends TranslationsTrackersDeviceCodeEn {
	...
	// Translations
	@override String title({required Object service}) => 'Активиране на Vibe в ${service}';
...
extension on TranslationsBg {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'settings.supportDeveloper' => 'Подкрепи Vibe',
			...
			'settings.importSettingsInvalidFile' => 'Този файл не е валиден експорт на настройки от Vibe',
			...
			'settings.startInFullscreenDescription' => 'Отваряй Vibe в режим цял екран при стартиране',
			...
			'settings.startupSectionDescription' => 'Изберете кой раздел да отваря Vibe при стартиране',
			...
			'profiles.addPlezyProfile' => 'Добави Vibe профил',
			...
			'connections.editJellyfinIntro' => ({required Object serverName}) => 'Добавете или премахнете URL адреси за ${serverName}. Vibe ще използва достъпния URL адрес с най-ниска латентност.',
			...
			'companionRemote.pairing.discoveryDescription' => 'Vibe устройства със същия Plex акаунт се показват тук',
			...
			'companionRemote.pairing.noDevicesHint' => 'Отворете Vibe на настолен компютър и използвайте същия WiFi',
			...
			'companionRemote.pairing.sessionNotFound' => 'Устройството не е намерено. Уверете се, че Vibe работи на хоста.',
			...
			'trakt.disconnectConfirmBody' => 'Vibe ще спре да изпраща събития към Trakt. Можете да се свържете отново по всяко време.',
			...
			'trakt.watchedSyncDescription' => 'Когато маркирате елементи като гледани в Vibe, маркирай ги и в Trakt.',
			...
			'trackers.disconnectConfirmBody' => ({required Object service}) => 'Vibe ще спре да обновява ${service}. Можете да се свържете отново по всяко време.',
			'trackers.connectFailed' => ({required Object service}) => 'Неуспешно свързване с ${service}. Опитайте отново.',
			'trackers.services.mal' => 'MyAnimeList',
			'trackers.services.anilist' => 'AniList',
			'trackers.services.simkl' => 'Simkl',
			'trackers.deviceCode.title' => ({required Object service}) => 'Активиране на Vibe в ${service}',
