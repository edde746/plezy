...
class _AddDirectPlexScreenState extends State<AddDirectPlexScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final title = widget.targetProfile != null
        ...
        : t.addServer.addMediaBrowserTitle(product: 'Plex');
    ...
    return [
      FocusableTextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: 'http://192.168.1.100:32400',
      ...
      if (info == null) ...[
        DiscoveredServerSection<DiscoveredPlexServer>(
          ...
          discoveringText: t.addServer.searchingLocalMediaBrowserServers(product: 'Plex'),
          sectionTitle: t.addServer.localMediaBrowserServers(product: 'Plex'),
