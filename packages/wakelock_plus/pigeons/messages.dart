...
@ConfigurePigeon(
  PigeonOptions(
    ...
    objcOptions: ObjcOptions(prefix: 'WAKELOCKPLUS', headerIncludePath: './include/wakelock_plus/messages.g.h'),
    kotlinOptions: KotlinOptions(errorClassName: 'WakelockPlusFlutterError'),
    kotlinOut: 'android/src/main/kotlin/dev/fluttercommunity/plus/wakelock/WakelockPlusMessages.g.kt',
  ),
)
@HostApi()
